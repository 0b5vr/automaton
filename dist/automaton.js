...
},{"core-js/library/fn/math/log10":5}],2:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/math/sign"), __esModule: true };
},{"core-js/library/fn/math/sign":6}],3:[function(require,module,exports){
...
},{"../../modules/_core":10,"../../modules/es6.math.log10":25}],6:[function(require,module,exports){
require('../../modules/es6.math.sign');
module.exports = require('../../modules/_core').Math.sign;

},{"../../modules/_core":10,"../../modules/es6.math.sign":26}],7:[function(require,module,exports){
...
},{"../../modules/_core":10,"../../modules/es6.object.define-property":27}],8:[function(require,module,exports){
...
},{"./_an-object":9,"./_descriptors":12,"./_ie8-dom-define":19,"./_to-primitive":24}],23:[function(require,module,exports){
...
},{"./_export":14}],26:[function(require,module,exports){
// 20.2.2.28 Math.sign(x)
var $export = require('./_export');

$export($export.S, 'Math', { sign: require('./_math-sign') });

},{"./_export":14,"./_math-sign":21}],27:[function(require,module,exports){
var $export = require('./_export');
// 19.1.2.4 / 15.2.3.6 Object.defineProperty(O, P, Attributes)
$export($export.S + $export.F * !require('./_descriptors'), 'Object', { defineProperty: require('./_object-dp').f });

},{"./_descriptors":12,"./_export":14,"./_object-dp":22}],28:[function(require,module,exports){
...
},{"_process":28,"timers":29}],32:[function(require,module,exports){
...
},{"./clock":36}],35:[function(require,module,exports){
'use strict';
...
},{"./clock":36}],36:[function(require,module,exports){
"use strict";
...
var compat = function compat(_data) {
  ...
  if (v < 2.0) {
    var _loop = function _loop(name) {
      var param = data.params[name];
      data.params[name] = {
        nodes: param.map(function (node, i) {
          return {
            time: node.time,
            value: node.value,
            in: i === 0 ? undefined : { time: -_paramGui2.default.DEFAULT_HANDLE_LENGTH, value: 0.0 },
            out: i === param.length - 1 ? undefined : { time: _paramGui2.default.DEFAULT_HANDLE_LENGTH, value: 0.0 }
          };
        }),
        fxs: []
      };
...
},{"./param-gui":47}],38:[function(require,module,exports){
"use strict";
...
var AutomatonWithGUI = function (_Automaton) {
  ...
  _createClass(AutomatonWithGUI, [{
    ...
    key: 'pushHistory',
    value: function pushHistory(_desc, _do, _undo) {
...
},{"./ass":33,"./compat":37,"./main":46,"./param-gui":47,"./vue/main.vue":50,"vue":31}],46:[function(require,module,exports){
'use strict';
...
},{"./clock":36,"./clock-frame":34,"./clock-realtime":35,"./param":48}],47:[function(require,module,exports){
'use strict';
...
var ParamWithGUI = function (_Param) {
  ...
  function ParamWithGUI(_props) {
    ...
    return _possibleConstructorReturn(this, (ParamWithGUI.__proto__ || Object.getPrototypeOf(ParamWithGUI)).call(this, props));
  }
  ...
  _createClass(ParamWithGUI, [{
    key: '__validateNodeIndex',
    value: function __validateNodeIndex(_index) {
      (0, _ass2.default)(0 <= _index && _index < this.__nodes.length, 'Invalid node index: ' + _index);
    }
    ...
    key: '__set',
    value: function __set(_target, _key, _value) {
      _vue2.default.set(_target, _key, _value);
    }
    ...
    key: 'dumpNode',
    value: function dumpNode(_index) {
      return (0, _jsonCopy2.default)(this.__nodes[_index]);
    }
    ...
    value: function createNodeFromData(_obj) {
      this.__nodes.push((0, _jsonCopy2.default)(_obj));
      this.__sortNodes();
    ...
    key: 'moveNode',
    value: function moveNode(_index, _time, _value) {
      this.__validateNodeIndex(_index);

      var node = this.__nodes[_index];
    ...
    key: 'moveHandle',
    value: function moveHandle(_index, _isOut, _time, _value) {
      this.__validateNodeIndex(_index);

      if (_index === 0 && !_isOut || _index === this.getNumNode() - 1 && _isOut) {
        return;
      }
    ...
    key: 'resetHandle',
    value: function resetHandle(_index, _isOut) {
      this.__validateNodeIndex(_index);
    ...
    key: '__validateFxIndex',
    value: function __validateFxIndex(_index) {
      (0, _ass2.default)(0 <= _index && _index < this.__fxs.length, 'Invalid fx index: ' + _index);
    }
    ...
    key: 'dumpFx',
    value: function dumpFx(_index) {
      return (0, _jsonCopy2.default)(this.__fxs[_index]);
    }
    ...
    key: 'removeFx',
    value: function removeFx(_index) {
    ...
    key: 'moveFx',
    value: function moveFx(_index, _time) {
      this.__validateFxIndex(_index);

      var fx = this.__fxs[_index];
    ...
    key: 'changeFxRow',
    value: function changeFxRow(_index, _row) {
      this.__validateFxIndex(_index);
      if (_row < 0 || 4 < _row) {
        return _index;
      }
    ...
    key: 'forceMoveFx',
    value: function forceMoveFx(_index, _time, _row) {
      this.__validateFxIndex(_index);
    ...
    key: 'resizeFx',
    value: function resizeFx(_index, _length) {
      this.__validateFxIndex(_index);
    ...
    key: 'resizeFxByLeft',
    value: function resizeFxByLeft(_index, _length) {
      this.__validateFxIndex(_index);
...
},{"./ass":33,"./json-copy":44,"./main-gui":45,"./param":48,"vue":31}],48:[function(require,module,exports){
'use strict';
  ...
  _createClass(Param, [{
    ...
    value: function precalc() {
      ...
      for (var iFx = 0; iFx < this.__fxs.length; iFx++) {
        ...
        var fxDef = this.__automaton.__paramFxs[fx.name];
        if (!fxDef) {
          continue;
        }

        var _i = Math.floor(this.__automaton.resolution * fx.time);
        ...
        for (var _i3 = _i; _i3 < _i2; _i3++) {
          context.i = _i3;
          context.t = _i3 / this.__automaton.resolution;
          this.__values[_i3] = fxDef.func(context);
        }
      }
    }
...
},{"./cubic-bezier":38,"./main":46}],49:[function(require,module,exports){
var __vueify_style_dispose__ = require("vueify/lib/insert-css").insert("/* line 76, stdin */\n.root[data-v-645e0595] {\n  position: absolute;\n  left: 0;\n  top: 0;\n  width: calc( 100% - 0.4em);\n  height: calc( 100% - 0.4em);\n  padding: 0.2em;\n  background: #333;\n  color: #fff; }\n  /* line 87, stdin */\n  .root .title[data-v-645e0595] {\n    margin-left: 0.4em;\n    margin-right: 0.4em;\n    font-size: 1.6em; }\n  /* line 94, stdin */\n  .root .version[data-v-645e0595] {\n    font-size: 0.8em; }\n  /* line 98, stdin */\n  .root .buttons[data-v-645e0595] {\n    position: absolute;\n    right: 0.4em;\n    top: 0; }\n    /* line 103, stdin */\n    .root .buttons .button[data-v-645e0595] {\n      width: 24px;\n      height: 24px;\n      margin: 3px;\n      cursor: pointer; }\n      /* line 110, stdin */\n      .root .buttons .button[data-v-645e0595]:hover {\n        opacity: 0.7; }")
;(function(){
'use strict';
  ...
  data: function data() {
    ...
    return {
      buttons: [{
        ...
        func: function func() {
          _this.automaton.undo();
        }
      }, {
        name: 'Redo',
        image: require('../images/redo.svg'),
        func: function func() {
          _this.automaton.redo();
        }
      }, {
        name: 'Snap',
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('div',{staticClass:"root"},[_c('span',{staticClass:"title"},[_vm._v("Automaton")]),_vm._v(" "),_c('span',{staticClass:"version"},[_vm._v("v"+_vm._s(_vm.automaton.version))]),_vm._v(" "),_c('div',{staticClass:"buttons"},_vm._l((_vm.buttons),function(button){return _c('img',{key:'button' + button.name,staticClass:"button",attrs:{"src":button.image},on:{"click":button.func}})}))])])}
...
},{"../images/cog.svg":39,"../images/redo.svg":40,"../images/save.svg":41,"../images/snap.svg":42,"../images/undo.svg":43,"vue":31,"vue-hot-reload-api":30,"vueify/lib/insert-css":32}],50:[function(require,module,exports){
...
exports.default = {
  ...
  methods: {
    ...
    selectNode: function selectNode(arr) {
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('div',{staticClass:"automaton root"},[_c('Header',{staticClass:"header",attrs:{"automaton":_vm.automaton}}),_vm._v(" "),_c('ParamList',{staticClass:"paramlist",attrs:{"automaton":_vm.automaton,"selectedParamName":_vm.selectedParamName},on:{"selected":function($event){_vm.selectParam( $event )}}}),_vm._v(" "),_c('PropMenu',{staticClass:"propmenu",attrs:{"automaton":_vm.automaton,"selectedParamName":_vm.selectedParamName,"selectedNodesIndex":_vm.selectedNodesIndex}}),_vm._v(" "),_c('Timeline',{staticClass:"timeline",attrs:{"automaton":_vm.automaton,"selectedParamName":_vm.selectedParamName,"selectedNodesIndex":_vm.selectedNodesIndex},on:{"selected":function($event){_vm.selectedNodesIndex = $event}}})],1)])}
__vue__options__.staticRenderFns = []
...
},{"./header.vue":49,"./paramlist.vue":51,"./propmenu.vue":53,"./timeline.vue":54,"vue":31,"vue-hot-reload-api":30,"vueify/lib/insert-css":32}],51:[function(require,module,exports){
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('div',{staticClass:"root"},_vm._l((_vm.automaton.__params),function( param,name){return _c('div',{key:'param' + name,staticClass:"param",class:{ selected: name === _vm.selectedParamName },on:{"click":function($event){_vm.$emit( 'selected', name )}}},[_c('div',{staticClass:"name"},[_vm._v(_vm._s(name))]),_vm._v(" "),_c('div',{staticClass:"value"},[_vm._v(_vm._s(param.getValue().toFixed( 3 )))])])}))])}
__vue__options__.staticRenderFns = []
    ...
    mousedown: function mousedown(event) {
      ...
      if (this.type === 'number') {
        ...
        mouseEvents(function (event) {
          ...
          _this.$emit('changed', Number(v.toFixed(3)));
        }, function (event) {
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('div',{staticClass:"propbox"},[_c('div',{staticClass:"name"},[_vm._v(_vm._s(_vm.name))]),_vm._v(" "),(_vm.type === 'number')?_c('div',{staticClass:"number",class:{ readonly: _vm.readonly }},[_c('div',{staticClass:"valueText",on:{"mousedown":_vm.mousedown}},[_vm._v(_vm._s(_vm.value.toFixed( 3 )))]),_vm._v(" "),_c('input',{directives:[{name:"show",rawName:"v-show",value:(_vm.input),expression:"input"}],ref:"valueInput",staticClass:"valueInput",on:{"keydown":function($event){if(!('button' in $event)&&_vm._k($event.keyCode,"enter",13,$event.key,"Enter")){ return null; }return _vm.enter($event)},"blur":_vm.blur}})]):_vm._e(),_vm._v(" "),(_vm.type === 'boolean')?_c('div',{staticClass:"boolean",class:{ readonly: _vm.readonly },on:{"click":_vm.bToggle}},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.value),expression:"value"}],staticClass:"booleanCheck"})]):_vm._e()])])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
},{"babel-runtime/core-js/math/log10":1,"babel-runtime/core-js/math/sign":2,"vue":31,"vue-hot-reload-api":30,"vueify/lib/insert-css":32}],53:[function(require,module,exports){
var __vueify_style_dispose__ = require("vueify/lib/insert-css").insert("/* line 160, stdin */\n.root[data-v-4491d86c] {\n  position: absolute;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  padding-right: 20px;\n  background: #222;\n  color: #fff; }\n  /* line 171, stdin */\n  .root .node-props[data-v-4491d86c] {\n    padding: 10px 20px;\n    font-size: 12px; }")
;(function(){
'use strict';
...
exports.default = (0, _defineProperty3.default)({
  ...
  computed: {
    ...
    selectedNodeIndex: function selectedNodeIndex() {
      return this.selectedNodesIndex.length === 1 ? this.selectedNodesIndex[0] : null;
    },
    selectedNode: function selectedNode() {
      return this.selectedNodesIndex.length === 1 ? this.selectedParam.dumpNode(this.selectedNodeIndex) : null;
    }
  }
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('div',{staticClass:"root"},[(_vm.selectedNode)?_c('div',{staticClass:"node-props"},[_c('Propbox',{staticClass:"props",attrs:{"type":"number","name":"Time","value":_vm.selectedNode.time,"readonly":_vm.selectedNodeIndex === 0 || _vm.selectedNodeIndex === _vm.selectedParam.getNumNode() - 1},on:{"changed":function($event){_vm.selectedParam.moveNode( _vm.selectedNodeIndex, $event )},"finished":function($event){_vm.automaton.pushHistory( _vm.selectedParamname + ': Change Node Time', function () {
            _vm.selectedParam.moveNode( _vm.selectedNodeIndex, $event[ 1 ] );
          }, function () {
            _vm.selectedParam.moveNode( _vm.selectedNodeIndex, $event[ 0 ] );
          } );}}}),_vm._v(" "),_c('Propbox',{staticClass:"props",attrs:{"type":"number","name":"Value","value":_vm.selectedNode.value},on:{"changed":function($event){_vm.selectedParam.moveNode( _vm.selectedNodeIndex, undefined, $event )},"finished":function($event){_vm.automaton.pushHistory( _vm.selectedParamname + ': Change Node Value', function () {
            _vm.selectedParam.moveNode( _vm.selectedNodeIndex, undefined, $event[ 1 ] );
          }, function () {
            _vm.selectedParam.moveNode( _vm.selectedNodeIndex, undefined, $event[ 0 ] );
          } );}}}),_vm._v(" "),_c('Propbox',{staticClass:"props",attrs:{"type":"number","name":"In Time","value":_vm.selectedNode.in ? _vm.selectedNode.in.time : 0,"readonly":!_vm.selectedNode.in},on:{"changed":function($event){_vm.selectedParam.moveHandle( _vm.selectedNodeIndex, false, $event )},"finished":function($event){_vm.automaton.pushHistory( _vm.selectedParamname + ': Change Node Time', function () {
            _vm.selectedParam.moveHandle( _vm.selectedNodeIndex, false, $event[ 1 ] );
          }, function () {
            _vm.selectedParam.moveHandle( _vm.selectedNodeIndex, false, $event[ 0 ] );
          } );}}}),_vm._v(" "),_c('Propbox',{staticClass:"props",attrs:{"type":"number","name":"In Value","value":_vm.selectedNode.in ? _vm.selectedNode.in.value : 0,"readonly":!_vm.selectedNode.in},on:{"changed":function($event){_vm.selectedParam.moveHandle( _vm.selectedNodeIndex, false, undefined, $event )},"finished":function($event){_vm.automaton.pushHistory( _vm.selectedParamname + ': Change Node Value', function () {
            _vm.selectedParam.moveHandle( _vm.selectedNodeIndex, false, undefined, $event[ 1 ] );
          }, function () {
            _vm.selectedParam.moveHandle( _vm.selectedNodeIndex, false, undefined, $event[ 0 ] );
          } );}}}),_vm._v(" "),_c('Propbox',{staticClass:"props",attrs:{"type":"number","name":"Out Time","value":_vm.selectedNode.out ? _vm.selectedNode.out.time : 0,"readonly":!_vm.selectedNode.out},on:{"changed":function($event){_vm.selectedParam.moveHandle( _vm.selectedNodeIndex, true, $event )},"finished":function($event){_vm.automaton.pushHistory( _vm.selectedParamname + ': Change Node Time', function () {
            _vm.selectedParam.moveHandle( _vm.selectedNodeIndex, true, $event[ 1 ] );
          }, function () {
            _vm.selectedParam.moveHandle( _vm.selectedNodeIndex, true, $event[ 0 ] );
          } );}}}),_vm._v(" "),_c('Propbox',{staticClass:"props",attrs:{"type":"number","name":"Out Value","value":_vm.selectedNode.out ? _vm.selectedNode.out.value : 0,"readonly":!_vm.selectedNode.out},on:{"changed":function($event){_vm.selectedParam.moveHandle( _vm.selectedNodeIndex, true, undefined, $event )},"finished":function($event){_vm.automaton.pushHistory( _vm.selectedParamname + ': Change Node Value', function () {
            _vm.selectedParam.moveHandle( _vm.selectedNodeIndex, true, undefined, $event[ 1 ] );
          }, function () {
            _vm.selectedParam.moveHandle( _vm.selectedNodeIndex, true, undefined, $event[ 0 ] );
          } );}}})],1):_vm._e()])])}
__vue__options__.staticRenderFns = []
...
exports.default = {
  ...
  methods: {
    ...
    updateGraph: function updateGraph() {
      var param = this.automaton.getParam(this.selectedParamName);
      if (!param) {
        return;
      }
    ...
    createNode: function createNode(event) {
      var t = this.x2t(event.offsetX);
      var v = this.y2v(event.offsetY);

      var param = this.automaton.getParam(this.selectedParamName);
      var index = param.createNode(t, v);

      this.automaton.pushHistory(this.selectedParamName + ": Create Node", function () {
    ...
    removeNode: function removeNode(index) {
      var param = this.automaton.getParam(this.selectedParamName);
      if (index === 0 || index === param.getNumNode() - 1) {
        return;
      }

      var node = param.dumpNode(index);
      param.removeNode(index);

      this.automaton.pushHistory(this.selectedParamName + ": Remove Node", function () {
        param.removeNode(index);
      }, function () {
        param.createNodeFromData(node);
      });
    },
    removeHandle: function removeHandle(index, isOut) {
      var param = this.automaton.getParam(this.selectedParamName);
      var node = param.dumpNode(index);
      ...
      this.automaton.pushHistory(this.selectedParamName + ": Remove Handle", function () {
        param.moveHandle(index, isOut, 0.0, 0.0);
      }, function () {
        param.moveHandle(index, isOut, t0, v0);
      });
    },
    resetHandles: function resetHandles(index) {
      var param = this.automaton.getParam(this.selectedParamName);
      var node = param.dumpNode(index);
      ...
      this.automaton.pushHistory(this.selectedParamName + ": Reset Handles", function () {
        param.resetHandle(index, false);
        param.resetHandle(index, true);
      }, function () {
    ...
    grabHelper: function grabHelper(event, callback) {
      ...
      var move = function move(event) {
        var dt = _this2.x2t(event.clientX) - t0;
        var dv = _this2.y2v(event.clientY) - v0;
    ...
    grabNode: function grabNode(index, event) {
      ...
      var grabbedNodes = [index];

      var t0s = [];
      var v0s = [];
      grabbedNodes.forEach(function (index) {
        var node = param.dumpNode(index);
        t0s.push(node.time);
        v0s.push(node.value);
      });
      ...
      this.grabHelper(event, function (dt, dv, event, isUp) {
        ...
        grabbedNodes.map(function (index, i) {
        ...
        if (isUp) {
          ...
          _this3.automaton.pushHistory(_this3.selectedParamName + ": Move Nodes", function () {
            grabbedNodes.map(function (index, i) {
              param.moveNode(index, t0s[i] + dt, v0s[i] + dv);
            });
          }, function () {
    ...
    grabHandle: function grabHandle(index, isOut, event) {
      var _this4 = this;
      ...
      this.grabHelper(event, function (dt, dv, event, isUp) {
        ...
        if (isUp) {
          ...
          _this4.automaton.pushHistory(_this4.selectedParamName + ": Move Handle", function () {
            param.moveHandle(index, isOut, t, v);
            param.moveHandle(index, !isOut, tOp, vOp);
          }, function () {
            param.moveHandle(index, isOut, t0, v0);
    ...
    grabFxBody: function grabFxBody(index, event) {
      var _this5 = this;

      var param = this.automaton.getParam(this.selectedParamName);
      var fx = param.dumpFx(index);
      ...
      this.grabHelper(event, function (dt, dv, event, isUp) {
        ...
        if (isUp) {
          _this5.automaton.pushHistory(_this5.selectedParamName + ": Move Fx", function () {
    ...
    grabFxSide: function grabFxSide(index, isRight, event) {
      var _this6 = this;
      ...
      this.grabHelper(event, function (dt, dv, event, isUp) {
        if (isRight) {
          ...
          if (isUp) {
            _this6.automaton.pushHistory(_this6.selectedParamName + ": Resize Fx", function () {
              param.resizeFx(index, l0 + dt);
            }, function () {
    ...
    onWheel: function onWheel(event) {
      if (event.shiftKey) {
        ...
        var d = this.t1 - this.t0;
        var min = 0.02;
        var z = Math.max(0.005 * event.deltaY, min / d - 1.0);
        ...
        var _d = this.v1 - this.v0;
        var _min = 0.02;
        var max = 200.0;
        var _z = Math.max(Math.min(0.005 * event.deltaY, max / _d - 1.0), _min / _d - 1.0);

        this.v0 -= (cursorV - this.v0) * _z;
        this.v1 += (this.v1 - cursorV) * _z;
      } else {
        var deltaT = this.t1 - this.t0;
        var deltaV = this.v1 - this.v0;
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('div',{ref:"root",staticClass:"root",on:{"wheel":function($event){$event.preventDefault();return _vm.onWheel($event)},"dragstart":function($event){$event.preventDefault();},"dblclick":function($event){$event.stopPropagation();return _vm.createNode($event)}}},[_c('svg',{staticClass:"svg",attrs:{"width":_vm.width,"height":_vm.height,"viewBox":("0 0 " + _vm.width + " " + _vm.height)}},[_c('g',[_vm._l((_vm.grid.x),function( line,index){return _c('line',{key:'gridX'+index,staticClass:"grid",attrs:{"x1":line.pos,"y1":0,"x2":line.pos,"y2":_vm.height,"opacity":line.op}})}),_vm._v(" "),_vm._l((_vm.grid.y),function( line,index){return _c('line',{key:'gridY'+index,staticClass:"grid",attrs:{"x1":0,"y1":line.pos,"x2":_vm.width,"y2":line.pos,"opacity":line.op}})}),_vm._v(" "),_vm._l((_vm.grid.x),function( line,index){return _c('text',{key:'gridTextX'+index,staticClass:"gridText",attrs:{"x":line.pos + 2,"y":"10","opacity":line.op}},[_vm._v(_vm._s(line.val.toFixed( 3 )))])}),_vm._v(" "),_vm._l((_vm.grid.y),function( line,index){return _c('text',{key:'gridTextY'+index,staticClass:"gridText",attrs:{"x":"2","y":line.pos + 10,"opacity":line.op}},[_vm._v(_vm._s(line.val.toFixed( 3 )))])})],2),_vm._v(" "),(_vm.automaton.getParam( _vm.selectedParamName ))?_c('polyline',{staticClass:"graph",attrs:{"points":_vm.graphPoints}}):_vm._e(),_vm._v(" "),_c('line',{staticClass:"currentLine",attrs:{"x1":_vm.t2x( _vm.automaton.time ),"y1":"0","x2":_vm.t2x( _vm.automaton.time ),"y2":_vm.height}}),_vm._v(" "),_c('text',{staticClass:"currentText",attrs:{"x":_vm.t2x( _vm.automaton.time ) + 2,"y":_vm.height - 2}},[_vm._v(_vm._s(_vm.automaton.time.toFixed( 3 )))]),_vm._v(" "),(_vm.automaton.getParam( _vm.selectedParamName ))?_c('g',[_c('line',{staticClass:"currentLine",attrs:{"x1":"0","y1":_vm.v2y( _vm.automaton.getParam( _vm.selectedParamName ).getValue() ),"x2":_vm.width,"y2":_vm.v2y( _vm.automaton.getParam( _vm.selectedParamName ).getValue() )}}),_vm._v(" "),_c('text',{staticClass:"currentText",attrs:{"x":"2","y":_vm.v2y( _vm.automaton.getParam( _vm.selectedParamName ).getValue() ) - 2}},[_vm._v(_vm._s(_vm.automaton.getParam( _vm.selectedParamName ).getValue().toFixed( 3 )))]),_vm._v(" "),_c('circle',{staticClass:"currentPoint",attrs:{"r":"5","cx":_vm.t2x( _vm.automaton.time ),"cy":_vm.v2y( _vm.automaton.getParam( _vm.selectedParamName ).getValue() )}}),_vm._v(" "),_vm._l((_vm.automaton.getParam( _vm.selectedParamName ).__nodes),function( node,index){return _c('g',{key:'node'+index,staticClass:"node"},[_c('g',{staticClass:"handle"},[(node.in)?_c('line',{staticClass:"line",attrs:{"x1":_vm.t2x( node.time ),"y1":_vm.v2y( node.value ),"x2":_vm.t2x( node.time + node.in.time ),"y2":_vm.v2y( node.value + node.in.value )}}):_vm._e(),_vm._v(" "),(node.in)?_c('circle',{staticClass:"circle",attrs:{"r":"4","transform":'translate(' + _vm.t2x( node.time + node.in.time ) + ',' + _vm.v2y( node.value + node.in.value ) + ')'},on:{"mousedown":function($event){_vm.grabHandle( index, false, $event )},"dblclick":function($event){$event.stopPropagation();_vm.removeHandle( index, false )}}}):_vm._e(),_vm._v(" "),(node.out)?_c('line',{staticClass:"line",attrs:{"x1":_vm.t2x( node.time ),"y1":_vm.v2y( node.value ),"x2":_vm.t2x( node.time + node.out.time ),"y2":_vm.v2y( node.value + node.out.value )}}):_vm._e(),_vm._v(" "),(node.out)?_c('circle',{staticClass:"circle",attrs:{"r":"4","transform":'translate(' + _vm.t2x( node.time + node.out.time ) + ',' + _vm.v2y( node.value + node.out.value ) + ')'},on:{"mousedown":function($event){_vm.grabHandle( index, true, $event )},"dblclick":function($event){$event.stopPropagation();_vm.removeHandle( index, true )}}}):_vm._e()]),_vm._v(" "),_c('g',{staticClass:"body",class:{ selected: _vm.selectedNodesIndex.some( function ( i ) { return i === index; } ) },on:{"dblclick":function($event){$event.stopPropagation();_vm.removeNode( index )},"mousedown":[function($event){if(!$event.shiftKey){ return null; }$event.stopPropagation();_vm.resetHandles( index )},function($event){_vm.grabNode( index, $event )}]}},[(_vm.v0 <= node.value && node.value <= _vm.v1)?_c('circle',{staticClass:"circle",attrs:{"transform":'translate(' + _vm.t2x( node.time ) + ',' + _vm.v2y( node.value ) + ')',"r":"5"}}):_vm._e(),_vm._v(" "),(node.value < _vm.v0)?_c('path',{staticClass:"triangle",attrs:{"transform":'translate(' + _vm.t2x( node.time ) + ',' + _vm.height + ')',"d":"M 0 -4 L 5 -12 L -5 -12 z"}}):_vm._e(),_vm._v(" "),(_vm.v1 < node.value)?_c('path',{staticClass:"triangle",attrs:{"transform":'translate(' + _vm.t2x( node.time ) + ',0)',"d":"M 0 4 L -5 12 L 5 12 z"}}):_vm._e()])])}),_vm._v(" "),_vm._l((_vm.automaton.getParam( _vm.selectedParamName ).__fxs),function( fx,index){return _c('g',{key:'fx'+index,staticClass:"fx",attrs:{"transform":'translate(0,' + ( _vm.height - 24 - 16 * fx.row ) + ')'}},[_c('rect',{staticClass:"body",attrs:{"x":_vm.t2x( fx.time ),"width":_vm.t2x( fx.time + fx.length ) - _vm.t2x( fx.time ),"height":"16","rx":"5","ry":"5"},on:{"mousedown":function($event){_vm.grabFxBody( index, $event )}}}),_vm._v(" "),_c('rect',{staticClass:"side",attrs:{"x":_vm.t2x( fx.time ) - 3,"width":"6","height":"16"},on:{"mousedown":function($event){_vm.grabFxSide( index, false, $event )}}}),_vm._v(" "),_c('rect',{staticClass:"side",attrs:{"x":_vm.t2x( fx.time + fx.length ) - 3,"width":"6","height":"16"},on:{"mousedown":function($event){_vm.grabFxSide( index, true, $event )}}}),_vm._v(" "),_c('clipPath',{attrs:{"id":'fxclip'+index}},[_c('rect',{attrs:{"x":_vm.t2x( fx.time ),"width":_vm.t2x( fx.time + fx.length ) - _vm.t2x( fx.time ),"height":"16"}})]),_vm._v(" "),_c('g',{attrs:{"clip-path":'url(#fxclip' + index + ')'}},[_c('text',{staticClass:"text",attrs:{"x":_vm.t2x( fx.time ) + 4,"y":"12"}},[_vm._v(_vm._s(fx.name))])])])})],2):_vm._e()])])])}
__vue__options__.staticRenderFns = []

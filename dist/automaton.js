...
var Automaton = function Automaton(_props) {
	...
	automaton.update = function (_time) {
		if (props.fps) {
			...
			var _now = _time - Math.floor(_now / automaton.length) * automaton.length;
			_now = _now || automaton.time;
			automaton.deltaTime = _now - automaton.time;
			automaton.time = _now;
		}
	};

  ...
  if (true) {
    automaton.save = function () {
      ...
      for (var _name3 in automaton.params) {
        ...
        obj.params[_name3] = Object.assign({}, _param.nodes);
      }

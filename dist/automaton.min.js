...
"use strict";var _createClass=function(){function t(t,e){for(var a=0;a<e.length;a++){var o=e[a];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(t,o.key,o)}}return function(e,a,o){return a&&t(e.prototype,a),o&&t(e,o),e}}(),_clock=require("./clock"),_clock2=_interopRequireDefault(_clock),_clockFrame=require("./clock-frame"),_clockFrame2=_interopRequireDefault(_clockFrame),_clockRealtime=require("./clock-realtime"),_clockRealtime2=_interopRequireDefault(_clockRealtime),_param=require("./param"),_param2=_interopRequireDefault(_param);function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}var Automaton=function(){function t(e){var a=this;_classCallCheck(this,t),this.version="1.1.3",this.loadProps(e),this.auto=function(t){return a.__auto(t)}}return _createClass(t,[{key:"loadProps",value:function(t){this.props=t,this.data=JSON.parse(this.props.data),this.clock=this.props.fps?new _clockFrame2.default(this,fps):this.props.realtime?new _clockRealtime2.default(this):new _clock2.default(this),this.params={};for(var e in this.data.params){var a=new _param2.default(this);a.load(this.data.params[e]),this.params[e]=a}}},{key:"seek",value:function(t){this.clock.setTime(t),"function"==typeof it.props.onSeek&&this.props.onSeek(time)}},{key:"play",value:function(){this.clock.play(),"function"==typeof this.props.onPlay&&this.props.onPlay()}},{key:"pause",value:function(){this.clock.pause(),"function"==typeof this.props.onPause&&this.props.onPause()}},{key:"update",value:function(t){this.clock.update(t),this.props.loop&&this.data.length<this.clock.time&&this.clock.setTime(this.clock.time-Math.floor(this.clock.time/this.data.length)*this.data.length);for(var e in this.params)this.params[e].currentValue=this.params[e].getValue(this.clock.time)}},{key:"__auto",value:function(t){return this.params[t].currentValue}}]),t}();module.exports=Automaton,Automaton.default=Automaton;

},{"./clock":51,"./clock-frame":49,"./clock-realtime":50,"./param":62}],61:[function(require,module,exports){
...
},{"./xorshift":64}],62:[function(require,module,exports){

...
"use strict";var _createClass=function(){function e(e,t){for(var a=0;a<t.length;a++){var r=t[a];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,a,r){return a&&e(t.prototype,a),r&&e(t,r),t}}(),_ass=require("./ass"),_ass2=_interopRequireDefault(_ass),_compat=require("./compat"),_compat2=_interopRequireDefault(_compat),_paramGui=require("./param-gui"),_paramGui2=_interopRequireDefault(_paramGui),_main=require("./main"),_main2=_interopRequireDefault(_main),_vue=require("vue"),_vue2=_interopRequireDefault(_vue),_main3=require("./vue/main.vue"),_main4=_interopRequireDefault(_main3);function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var AutomatonWithGUI=function(e){function t(e){_classCallCheck(this,t);var a=Object.assign({},e);a.data=(0,_compat2.default)(a.data),(0,_ass2.default)(!e.onseek,'The handler "onseek" is no longer supported. Use Automaton.on( "seek", ... ) instead.'),(0,_ass2.default)(!e.onplay,'The handler "onplay" is no longer supported. Use Automaton.on( "play", ... ) instead.'),(0,_ass2.default)(!e.onpause,'The handler "onpause" is no longer supported. Use Automaton.on( "pause", ... ) instead.');var r=_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,a));return r.history=[],r.historyIndex=0,e.gui&&r.__prepareGUI(e.gui),r}return _inherits(t,_main2.default),_createClass(t,[{key:"__prepareGUI",value:function(e){var t=document.createElement("div");e.appendChild(t),this.vue=new _vue2.default({el:t,data:{automaton:this},render:function(e){return e(_main4.default,{props:{automaton:this.automaton}})}})}},{key:"togglePlay",value:function(){this.isPlaying?this.pause():this.play()}},{key:"__operate",value:function(e,t,a){return this.history.splice(this.historyIndex),this.history.push({do:t,undo:a}),this.historyIndex++,t()}},{key:"undo",value:function(){if(!(this.historyIndex<=0))return this.historyIndex--,this.history[this.historyIndex].undo()}},{key:"redo",value:function(){if(!(this.history.length<=this.historyIndex))return this.historyIndex++,this.history[this.historyIndex-1].do()}},{key:"__dropHistory",value:function(){this.history.splice(0),this.historyIndex=0}},{key:"setLength",value:function(e){if(isNaN(e))throw"Automaton.setLength: _len is invalid";for(var t in this.params){for(var a=this.params[t],r=a.nodes.length-1;0<r;r--){e<a.nodes[r].time&&a.nodes.splice(r,1)}var n=a.nodes[a.nodes.length-1];n.time!==e&&a.addNode(e,n.value)}this.data.length=e,this.__dropHistory()}},{key:"createParam",value:function(e){var t=new _paramGui2.default({automaton:this});return _vue2.default.set(this.__params,e,t),t}},{key:"deleteParam",value:function(e){_vue2.default.delete(this.__params,e)}},{key:"getParamNames",value:function(){var e=[];for(var t in this.__params)e.push(t);return e=e.sort()}},{key:"countParams",value:function(){var e=0;for(var t in this.__params)e++;return e}},{key:"__auto",value:function(e){var t=this.__params[e];return t||(t=this.createParam(e)),t.__used=!0,t.getValue()}},{key:"save",value:function(){var e=this.data;for(var t in e.params={},this.__params){var a=this.__params[t];e.params[t]=a.nodes}return JSON.parse(JSON.stringify(e))}}]),t}();module.exports=AutomatonWithGUI,AutomatonWithGUI.default=AutomatonWithGUI;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}(),_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},_ass=require("./ass"),_ass2=_interopRequireDefault(_ass),_mainGui=require("./main-gui"),_mainGui2=_interopRequireDefault(_mainGui),_param=require("./param"),_param2=_interopRequireDefault(_param);function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var cloneObj=function(e){if("object"!==(void 0===e?"undefined":_typeof(e)))return e;var t={};for(var r in e)t[r]=e[r];return t},ParamWithGUI=function(e){function t(e){_classCallCheck(this,t);var r=Object.assign({},e);return r.data=r.data?r.data:{nodes:[{time:0,value:0,out:{time:0,value:0}},{time:e.automaton.length,value:0,in:{time:0,value:0}}],fxs:[]},_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,r))}return _inherits(t,_param2.default),_createClass(t,[{key:"__validateNodeIndex",value:function(e){(0,_ass2.default)(0<e&&e<this.__nodes.length,"Invalid node index")}},{key:"__sortNodes",value:function(){this.__nodes.sort(function(e,t){return e.time-t.time})}}]),t}();exports.default=ParamWithGUI;
...
var __vueify_style_dispose__=require("vueify/lib/insert-css").insert("/* line 36, stdin */\n.root[data-v-1d1a854f] {\n  position: absolute;\n  left: 0;\n  top: 0;\n  width: calc( 100% - 0.8em);\n  height: calc( 100% - 0.4em);\n  padding: 0.2em 0.4em;\n  font-size: 14px;\n  background: #333; }\n  /* line 48, stdin */\n  .root .title[data-v-1d1a854f] {\n    font-size: 1.6em;\n    margin-right: 0.4em; }\n  /* line 53, stdin */\n  .root .version[data-v-1d1a854f] {\n    font-size: 0.8em; }");!function(){"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e,t=require("./header.vue"),o=(e=t)&&e.__esModule?e:{default:e};exports.default={components:{Header:o.default},mounted:function(){},beforeDestroy:function(){},props:["automaton"],data:function(){return{}},methods:{}}}(),module.exports.__esModule&&(module.exports=module.exports.default);var __vue__options__="function"==typeof module.exports?module.exports.options:module.exports;__vue__options__.functional&&console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions."),__vue__options__.render=function(){var e=this.$createElement,t=this._self._c||e;return t("div",[t("div",{staticClass:"root"},[t("span",{staticClass:"title"},[this._v("Automaton")]),this._v(" "),t("span",{staticClass:"version"},[this._v(this._s(this.automaton.version))])])])},__vue__options__.staticRenderFns=[],__vue__options__._scopeId="data-v-1d1a854f",module.hot&&function(){var e=require("vue-hot-reload-api");e.install(require("vue"),!0),e.compatible&&(module.hot.accept(),module.hot.dispose(__vueify_style_dispose__),module.hot.data?e.rerender("data-v-1d1a854f",__vue__options__):e.createRecord("data-v-1d1a854f",__vue__options__))}();

},{"./header.vue":16,"vue":4,"vue-hot-reload-api":3,"vueify/lib/insert-css":5}],17:[function(require,module,exports){
var __vueify_style_dispose__=require("vueify/lib/insert-css").insert("@import url(\"https://fonts.googleapis.com/css?family=Roboto\");\n/* line 41, stdin */\n.root[data-v-205ed4fb] {\n  font-family: 'Roboto', sans-serif; }\n  /* line 44, stdin */\n  .root .header[data-v-205ed4fb] {\n    position: absolute;\n    left: 0;\n    top: 0;\n    width: 100%;\n    height: 32px; }");!function(){"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e,o=require("./header.vue"),t=(e=o)&&e.__esModule?e:{default:e};exports.default={components:{Header:t.default},mounted:function(){},beforeDestroy:function(){},props:["automaton"],data:function(){return{}},methods:{}}}(),module.exports.__esModule&&(module.exports=module.exports.default);var __vue__options__="function"==typeof module.exports?module.exports.options:module.exports;__vue__options__.functional&&console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions."),__vue__options__.render=function(){var e=this.$createElement,o=this._self._c||e;return o("div",[o("div",{staticClass:"root"},[o("Header",{staticClass:"header",attrs:{automaton:this.automaton}})],1)])},__vue__options__.staticRenderFns=[],__vue__options__._scopeId="data-v-205ed4fb",module.hot&&function(){var e=require("vue-hot-reload-api");e.install(require("vue"),!0),e.compatible&&(module.hot.accept(),module.hot.dispose(__vueify_style_dispose__),module.hot.data?e.rerender("data-v-205ed4fb",__vue__options__):e.createRecord("data-v-205ed4fb",__vue__options__))}();

...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},_compat=require("./compat"),_compat2=_interopRequireDefault(_compat),_param2=require("./param"),_param3=_interopRequireDefault(_param2);function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var Vue=void 0,GUI=void 0;Vue=require("vue"),GUI=require("./gui.vue");var Automaton=function(e){var a={rev:20180121},t="object"===(void 0===e?"undefined":_typeof(e))?e:{},r=(0,_compat2.default)(t.data);a.time=0,a.deltaTime=0,a.isPlaying=!0,a.length=r.length,a.resolution=r.resolution,a.setLength=function(e){if(!isNaN(e)){for(var t in a.params){for(var r=a.params[t],n=r.nodes.length-1;0<n;n--){e<r.nodes[n].time&&r.nodes.splice(n,1)}r.nodes[r.nodes.length-1].time!==e&&r.addNode(e,0)}a.length=e}},a.params={},a.createParam=function(e){var t=new _param3.default(a);return Vue.set(a.params,e,t),t},a.deleteParam=function(e){Vue.delete(a.params,e)},a.getParamNames=function(){var e=[];for(var t in a.params)e.push(t);return e=e.sort()},a.countParams=function(){var e=0;for(var t in a.params)e++;return e};for(var n in r.params){a.createParam(n).load(r.params[n])}if(a.setLength(a.length),a.seek=function(e){var r=e-Math.floor(e/a.length)*a.length;a.update(r),"function"==typeof t.onseek&&t.onseek(r)},a.play=function(){a.isPlaying=!0,"function"==typeof t.onplay&&t.onplay()},a.pause=function(){a.isPlaying=!1,"function"==typeof t.onpause&&t.onpause()},t.gui){var o=document.createElement("div");t.gui.appendChild(o),a.vue=new Vue({el:o,data:{automaton:a},render:function(e){return e(GUI,{props:{automaton:this.automaton}})}}),a.guiParams="object"===_typeof(r.gui)?r.gui:{snap:{enable:!1,bpm:120,offset:0}}}return a.renderAll=function(){for(var e in a.params)a.params[e].render()},a.update=function(e){if(t.fps){if("number"!=typeof e&&a.frame&&a.isPlaying||(a.frame=Math.floor((e||a.time)*t.fps)),a.time=a.frame/t.fps,a.deltaTime=1/t.fps,a.isPlaying){var r=Math.floor(a.length*t.fps);a.frame=(a.frame+1)%r}}else if(t.realtime){var n=+new Date;"number"!=typeof e&&a.rtDate&&a.isPlaying||(a.rtTime=e||a.time,a.rtDate=n);var o=a.rtTime+.001*(n-a.rtDate);a.time=o%a.length,a.rtPrev||(a.rtPrev=n),a.deltaTime=.001*(n-a.rtPrev),a.rtPrev=n}else{var i=e%a.length;a.deltaTime=i-a.time,a.time=i}},a.auto=function(e){var t=a.params[e];return t||(t=a.createParam(e)),t.used=!0,t.getValue()},a.bye=function(){a=null},a.save=function(){var e={rev:a.rev,length:a.length,resolution:a.resolution,params:{}};for(var t in a.params){var r=a.params[t];e.params[t]=r.nodes}return a.guiParams&&(e.gui=a.guiParams),e},a};module.exports=Automaton;

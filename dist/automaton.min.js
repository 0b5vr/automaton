...
},{"./clock":71}],71:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},defaultData={v:"2.0.3",length:1,resolution:1e3,params:{},guiSettings:{snapActive:!1,snapTime:.1,snapValue:.1}},compat=function(e){if(!e)return Object.assign({},defaultData);var t=void 0;if("object"===(void 0===e?"undefined":_typeof(e)))t=e;else{if("string"!=typeof e)return console.error("Loaded data is invalid"),Object.assign({},defaultData);try{t=JSON.parse(e)}catch(e){return console.error("Loaded data is invalid"),Object.assign({},defaultData)}}var a=parseFloat(t.v);if(!a&&!t.rev){if(!t.gui)return console.error("Loaded data is not compatible with this revision"),Object.assign({},defaultData);delete t.gui,t.gui=Object.assign({},defaultData.gui)}if(t.rev&&(a=1,delete t.rev),a<2){var i=function(e){for(var a=t.params[e],i={nodes:a.map(function(e,t){return{time:e.time,value:e.value,in:0===t?void 0:{time:0,value:0},out:t===a.length-1?void 0:{time:0,value:0}}}),fxs:[]},s=0,o=1;o<a.length;o++){if(s++,0===a[o].mode)i.nodes.splice(s,0,{time:a[o].time,value:a[o-1].value,in:{time:0,value:0},out:{time:0,value:0}}),s++;else if(1===a[o].mode);else if(2===a[o].mode){var r=i.nodes[s].time-i.nodes[s-1].time;i.nodes[s-1].out={time:.37*r,value:0},i.nodes[s].in={time:.37*-r,value:0}}else i.nodes.splice(s,0,{time:a[o-1].time,value:a[o].value,in:{time:0,value:0},out:{time:0,value:0}}),s++,3===a[o].mode?i.fxs.push({name:"Exponential Smoothing",bypass:!1,row:0,time:a[o-1].time-1/t.resolution,length:a[o].time-a[o-1].time,params:{factor:a[o].params.factor,preserve:!0}}):4===a[o].mode?i.fxs.push({name:"Critically Damped Spring",bypass:!1,row:0,time:a[o-1].time-1/t.resolution,length:a[o].time-a[o-1].time,params:{factor:a[o].params.rate,ratio:a[o].params.damp,preserve:!0}}):5===a[o].mode&&i.fxs.push({name:"Gravity",bypass:!1,row:0,time:a[o-1].time-1/t.resolution,length:a[o].time-a[o-1].time,params:{a:a[o].params.gravity,e:a[o].params.bounce,preserve:!0}});a[o].mods[1]&&i.fxs.push({name:"Sinewave",bypass:!1,row:1,time:a[o-1].time,length:a[o].time-a[o-1].time,params:{freq:a[o].mods[1].freq,amp:a[o].mods[1].amp,phase:a[o].mods[1].phase}}),a[o].mods[2]&&i.fxs.push({name:"Fractal Noise",bypass:!1,row:2,time:a[o-1].time,length:a[o].time-a[o-1].time,params:{amp:a[o].mods[2].amp,recursion:a[o].mods[2].recursion,freq:a[o].mods[2].freq,reso:a[o].mods[2].reso,seed:a[o].mods[2].seed}}),a[o].mods[3]&&i.fxs.push({name:"Lo-Fi",bypass:!1,row:3,time:a[o-1].time,length:a[o].time-a[o-1].time,params:{resolution:a[o].mods[3].freq,relative:!0}})}t.params[e]=i};for(var s in t.params)i(s);t.guiSettings={snapActive:!1,snapTime:.1,snapValue:.1}}return t.v="2.0.3",t};exports.default=compat;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=[require("./fxs/add").default,require("./fxs/cds").default,require("./fxs/clamp").default,require("./fxs/exp").default,require("./fxs/gravity").default,require("./fxs/lofi").default,require("./fxs/noise").default,require("./fxs/pow").default,require("./fxs/sine").default];

},{"./fxs/add":75,"./fxs/cds":76,"./fxs/clamp":77,"./fxs/exp":78,"./fxs/gravity":79,"./fxs/lofi":80,"./fxs/noise":82,"./fxs/pow":83,"./fxs/sine":84}],75:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=["add",{name:"Add",description:"The simplest fx ever. Just add a constant value to the curve.",params:{value:{name:"Value",type:"float",default:1}},func:function(e){return e.v+e.params.value}}];

},{}],76:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=["cds",{name:"Critically Damped Spring",description:"Basically the best smoothing method. Shoutouts to Keijiro Takahashi",params:{factor:{name:"Factor",type:"float",default:100,min:0},ratio:{name:"Damp Ratio",type:"float",default:1},preserve:{name:"Preserve Velocity",type:"boolean",default:!1}},func:function(e){var t=e.dt,a=e.v,r=e.params.factor;if(e.init)if(e.pos=e.v,e.params.preserve){var o=a-e.getValue(e.t-t);e.vel=o/t}else e.vel=0;return e.vel+=(-r*(e.pos-a)-2*e.vel*Math.sqrt(r)*e.params.ratio)*t,e.pos+=e.vel*t,e.pos}}];

},{}],77:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var clamp=function(a,t,m){return Math.min(Math.max(a,t),m)},smin=function(a,t,m){var e=Math.max(m-Math.abs(a-t),0);return Math.min(a,t)-e*e*e/(6*m*m)};exports.default=["clamp",{name:"Clamp",description:"Constrain the curve between two values, featuring smooth minimum.",params:{min:{name:"Min",type:"float",default:0},max:{name:"Max",type:"float",default:1},smooth:{name:"Smooth",type:"float",default:0,min:0}},func:function(a){if(0===a.params.smooth)return clamp(a.v,a.params.min,a.params.max);var t=-smin(-a.params.min,-a.v,a.params.smooth);return smin(a.params.max,t,a.params.smooth)}}];

},{}],78:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=["exp",{name:"Exponential Smoothing",description:"Smooth the curve. Simple but good.",params:{factor:{name:"Factor",type:"float",default:10,min:0}},func:function(t){var e=t.v;t.init&&(t.pos=e);var o=Math.exp(-t.dt*t.params.factor);return t.pos=t.pos*o+e*(1-o),t.pos}}];

},{}],79:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=["gravity",{name:"Gravity",description:"Accelerate and bounce the curve.",params:{a:{name:"Acceleration",type:"float",default:9.8},e:{name:"Restitution",type:"float",default:.5,min:0},preserve:{name:"Preserve Velocity",type:"boolean",default:!1}},func:function(e){var a=e.dt,t=e.v;if(e.init)if(e.pos=t,e.params.preserve){var r=t-e.getValue(e.t-a);e.vel=r/a}else e.vel=0;var s=Math.sign(t-e.pos)*e.params.a;return e.vel+=s*a,e.pos+=e.vel*a,Math.sign(s)!==Math.sign(t-e.pos)&&(e.vel*=-e.params.e,e.pos=t+e.params.e*(t-e.pos)),e.pos}}];

},{}],80:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=["lofi",{name:"Lo-Fi",description:"Make curve more crunchy.",params:{rate:{name:"Frame Rate",type:"float",default:10,min:0,max:1e3},relative:{name:"Relative",type:"boolean",default:!1},reso:{name:"Reso Per Unit",type:"float",default:.1,min:0,max:1e3},round:{name:"Round",type:"boolean",default:!1}},func:function(a){var e=void 0;e=0===a.params.rate?a.t:a.params.relative?a.t0+Math.floor((a.t-a.t0)*a.params.rate)/a.params.rate:Math.floor(a.t*a.params.rate)/a.params.rate;var r=a.getValue(e);return 0!==a.params.reso&&(r=Math.floor(r*a.params.reso+(a.params.round?.5:0))/a.params.reso),r}}];

},{}],81:[function(require,module,exports){
"use strict";var _createClass=function(){function e(e,t){for(var s=0;s<t.length;s++){var n=t[s];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,s,n){return s&&e(t.prototype,s),n&&e(t,n),t}}();function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var Xorshift=function(){function e(t){_classCallCheck(this,e),this.set(t)}return _createClass(e,[{key:"gen",value:function(e){return e&&this.set(e),this.seed=this.seed^this.seed<<13,this.seed=this.seed^this.seed>>>17,this.seed=this.seed^this.seed<<5,this.seed/Math.pow(2,32)+.5}},{key:"set",value:function(e){this.seed=e||this.seed||1}}]),e}();module.exports=Xorshift;

},{}],82:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var _xorshift=require("./modules/xorshift"),_xorshift2=_interopRequireDefault(_xorshift);function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var xorshift=new _xorshift2.default,smoothstep=function(e,r,t){return e+(r-e)*(t*t*(3-2*t))};exports.default=["noise",{name:"Fractal Noise",description:"wiggle()",params:{recursion:{name:"Recursion",type:"int",default:4,min:1,max:99},freq:{name:"Frequency",type:"float",default:1,min:0},reso:{name:"Resolution",type:"float",default:8,min:1},seed:{name:"Seed",type:"int",default:1,min:0},amp:{name:"Amp",type:"float",default:.2}},func:function(e){if(e.init){xorshift.gen(e.params.seed),e.table=new Float32Array(Math.floor(e.params.reso)+2);for(var r=1;r<e.params.reso;r++)e.table[r]=2*xorshift.gen()-1}for(var t=e.v,a=e.progress,o=0;o<e.params.recursion;o++){var s=a*e.params.freq*e.params.reso*Math.pow(2,o)%e.params.reso,n=Math.floor(s),i=s-n,f=Math.pow(.5,o+1);t+=e.params.amp*f*smoothstep(e.table[n],e.table[n+1],i)}return t}}];

},{"./modules/xorshift":81}],83:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=["pow",{name:"Power",description:"You got boost power!",params:{pow:{name:"Power",type:"float",default:2},bias:{name:"Bias",type:"float",default:0},positive:{name:"Force Positive",type:"boolean",default:!1}},func:function(a){var e=a.v-a.params.bias,t=a.params.positive?1:Math.sign(e);return Math.pow(Math.abs(e),a.params.pow)*t+a.params.bias}}];

},{}],84:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var TAU=2*Math.PI;exports.default=["sine",{name:"Sinewave",description:"Overlay a sinewave to the curve.",params:{amp:{name:"Amp",type:"float",default:.1},freq:{name:"Frequency",type:"float",default:5},phase:{name:"Phase",type:"float",default:0,min:0,max:1}},func:function(e){var a=e.v,t=e.progress*e.params.freq+e.params.phase;return a+e.params.amp*Math.sin(t*TAU)}}];

},{}],85:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=function(){for(var t="",e=0;e<16;e++)t+=Math.floor(16*Math.random()).toString(16);return t};

},{}],86:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var hasOverwrap=function e(r,t,a,s){return s<t?e(a,s,r,t):a<r&&r<a+s||a<r+t&&r+t<a+s};exports.default=hasOverwrap;
...
module.exports="data:image/svg+xml,%3Csvg   xmlns='http://www.w3.org/2000/svg'   viewBox='0 0 100 100'   width='256'   height='256'   font-family='Helvetica Neue'   font-weight='300' %3E   %3Cpath     fill='none'     stroke='%23222'     stroke-width='20'     stroke-linecap='round'     stroke-linejoin='round'      d='       M 50 50       m -16 -32       l 32 0       l 16 16       l 0 32       l -16 16       l -32 0       l -16 -16       l 0 -32       l 16 -16       z     '   /%3E   %3Cpath     fill='%23f32'     stroke='%23f32'     stroke-width='5'     stroke-linecap='round'     stroke-linejoin='round'      d='       M 50 50       m -16 -32       l 32 0       l 16 16       l 0 32       l -16 16       l -32 0       l -16 -16       l 0 -32       l 16 -16       z     '   /%3E   %3Cpath     fill='%23222'     stroke='%23222'     stroke-width='5'     stroke-linecap='round'     stroke-linejoin='round'      d='       M 50 50       m 0 -6       l 14 -14       l 6 6       l -14 14       l 14 14       l -6 6       l -14 -14       l -14 14       l -6 -6       l 14 -14       l -14 -14       l 6 -6       l 14 14       z     '   /%3E %3C/svg%3E";
...
"use strict";var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var i=t[r];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,r,i){return r&&e(t.prototype,r),i&&e(t,i),t}}(),_get=function e(t,r,i){null===t&&(t=Function.prototype);var n=Object.getOwnPropertyDescriptor(t,r);if(void 0===n){var o=Object.getPrototypeOf(t);return null===o?void 0:e(o,r,i)}if("value"in n)return n.value;var a=n.get;return void 0!==a?a.call(i):void 0},_ass=require("./ass"),_ass2=_interopRequireDefault(_ass),_compat=require("./compat"),_compat2=_interopRequireDefault(_compat),_jsonCopy=require("./json-copy"),_jsonCopy2=_interopRequireDefault(_jsonCopy),_paramGui=require("./param-gui"),_paramGui2=_interopRequireDefault(_paramGui),_main=require("./main"),_main2=_interopRequireDefault(_main),_fxDefinitions=require("./fx-definitions"),_fxDefinitions2=_interopRequireDefault(_fxDefinitions),_vue=require("vue"),_vue2=_interopRequireDefault(_vue),_main3=require("./vue/main.vue"),_main4=_interopRequireDefault(_main3);function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _toConsumableArray(e){if(Array.isArray(e)){for(var t=0,r=Array(e.length);t<e.length;t++)r[t]=e[t];return r}return Array.from(e)}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var AutomatonWithGUI=function(e){function t(e){_classCallCheck(this,t);var r=Object.assign({},e);(0,_ass2.default)(!e.onseek,'The handler "onseek" is no longer supported. Use Automaton.on( "seek", ... ) instead.'),(0,_ass2.default)(!e.onplay,'The handler "onplay" is no longer supported. Use Automaton.on( "play", ... ) instead.'),(0,_ass2.default)(!e.onpause,'The handler "onpause" is no longer supported. Use Automaton.on( "pause", ... ) instead.');var i=_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,r));return i.__history=[],i.__historyIndex=0,_fxDefinitions2.default.map(function(e){i.addFxDefinition.apply(i,_toConsumableArray(e))}),e.gui&&i.__prepareGUI(e.gui),window.addEventListener("beforeunload",function(e){if(0!==i.__historyIndex){return e.returnValue="Automaton: Did you saved your progress?","Automaton: Did you saved your progress?"}}),i}return _inherits(t,_main2.default),_createClass(t,[{key:"__prepareGUI",value:function(e){var t=document.createElement("div");e.appendChild(t),this.__vue=new _vue2.default({el:t,data:{automaton:this},render:function(e){return e(_main4.default,{props:{automaton:this.automaton}})}})}},{key:"generateDefaultFxParams",value:function(e){var t=this.__paramFxDefs[e];if(!t)throw new Error("Fx definition called "+e+" is not defined");var r={};for(var i in t.params)r[i]=t.params[i].default;return r}},{key:"togglePlay",value:function(){this.isPlaying?this.pause():this.play()}},{key:"pushHistory",value:function(e,t,r,i){if(this.__history.splice(this.__historyIndex),this.__history.push({desc:e,do:t,undo:r}),this.__historyIndex++,i)return t()}},{key:"undo",value:function(){if(!(this.__historyIndex<=0))return this.__historyIndex--,this.__history[this.__historyIndex].undo()}},{key:"redo",value:function(){if(!(this.__history.length<=this.__historyIndex))return this.__historyIndex++,this.__history[this.__historyIndex-1].do()}},{key:"getUndoDesc",value:function(){return this.__history[this.__historyIndex-1]?this.__history[this.__historyIndex-1].desc:""}},{key:"getRedoDesc",value:function(){return this.__history[this.__historyIndex]?this.__history[this.__historyIndex].desc:""}},{key:"dropHistory",value:function(){this.__history.splice(0),this.__historyIndex=0}},{key:"setLength",value:function(e){if(isNaN(e))throw new Error("Automaton.setLength: _length is invalid");if(e!==this.length){for(var t in this.__params){this.__params[t].changeLength(e)}this.__length=e,this.dropHistory(),this.__vue.$emit("changedLength")}}},{key:"setResolution",value:function(e){this.__resolution=e,this.precalcAll()}},{key:"createParam",value:function(e,t){var r=new _paramGui2.default({automaton:this,data:t});return _vue2.default.set(this.__params,e,r),r}},{key:"removeParam",value:function(e){_vue2.default.delete(this.__params,e)}},{key:"getParam",value:function(e){return this.__params[e]||null}},{key:"getParamNames",value:function(){var e=[];for(var t in this.__params)e.push(t);return e=e.sort()}},{key:"getFxDefinitionIds",value:function(){var e=[];for(var t in this.__paramFxDefs)e.push(t);return e=e.sort()}},{key:"getFxDefinitionName",value:function(e){return this.__paramFxDefs[e]?this.__paramFxDefs[e].name||e:void 0}},{key:"getFxDefinitionDescription",value:function(e){return this.__paramFxDefs[e]?this.__paramFxDefs[e].description||"":void 0}},{key:"getFxDefinitionParams",value:function(e){return this.__paramFxDefs[e]?(0,_jsonCopy2.default)(this.__paramFxDefs[e].params||{}):void 0}},{key:"countParams",value:function(){var e=0;for(var t in this.__params)e++;return e}},{key:"__auto",value:function(e){var t=this.__params[e];return t||(t=this.createParam(e)),t.markAsUsed(),t.getValue()}},{key:"load",value:function(e){var r=(0,_compat2.default)(e);_get(t.prototype.__proto__||Object.getPrototypeOf(t.prototype),"load",this).call(this,r),this.guiSettings=r.guiSettings,this.__vue&&this.__vue.$emit("loaded"),this.__history&&this.dropHistory()}},{key:"save",value:function(){var e={v:this.version,length:this.length,resolution:this.resolution,params:{},guiSettings:this.guiSettings};for(var t in e.params={},this.__params){var r=this.__params[t];e.params[t]={nodes:r.dumpNodesWithoutId(),fxs:r.dumpFxsWithoutId()}}return JSON.stringify(e)}},{key:"pokeRenderer",value:function(){this.__vue&&this.__vue.$emit("poke")}}]),t}();module.exports=AutomatonWithGUI,AutomatonWithGUI.default=AutomatonWithGUI;

},{"./ass":68,"./compat":72,"./fx-definitions":74,"./json-copy":99,"./main":101,"./param-gui":102,"./vue/main.vue":107,"vue":66}],101:[function(require,module,exports){
"use strict";var _createClass=function(){function e(e,t){for(var i=0;i<t.length;i++){var a=t[i];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(t,i,a){return i&&e(t.prototype,i),a&&e(t,a),t}}(),_clock=require("./clock"),_clock2=_interopRequireDefault(_clock),_clockFrame=require("./clock-frame"),_clockFrame2=_interopRequireDefault(_clockFrame),_clockRealtime=require("./clock-realtime"),_clockRealtime2=_interopRequireDefault(_clockRealtime),_param=require("./param"),_param2=_interopRequireDefault(_param);function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var Automaton=function(){function e(t){var i=this;_classCallCheck(this,e),this.__version="2.0.3",this.loop=t.loop||!1,this.__clock=t.fps?new _clockFrame2.default(this,t.fps):t.realtime?new _clockRealtime2.default(this):new _clock2.default(this),this.__listeners={},this.__paramFxDefs={};var a=t.data;this.load(a),this.auto=function(e){return i.__auto(e)}}return _createClass(e,[{key:"createParam",value:function(e,t){this.__params[name]=new _param2.default({automaton:this,data:t})}},{key:"load",value:function(e){for(var t in this.__length=e.length,this.__resolution=e.resolution,this.__params={},e.params)this.createParam(t,e.params[t])}},{key:"seek",value:function(e){this.__clock.setTime(e),this.__emit("seek")}},{key:"play",value:function(){this.__clock.play(),this.__emit("play")}},{key:"pause",value:function(){this.__clock.pause(),this.__emit("pause")}},{key:"addFxDefinition",value:function(e,t){this.__paramFxDefs[e]=t,this.precalcAll()}},{key:"__emit",value:function(e){for(var t=arguments.length,i=Array(t>1?t-1:0),a=1;a<t;a++)i[a-1]=arguments[a];this.__listeners[e]&&this.__listeners[e].map(function(e){return e.apply(void 0,i)})}},{key:"on",value:function(e,t){this.__listeners[e]||(this.__listeners[e]=[]),this.__listeners[e].push(t)}},{key:"precalcAll",value:function(){for(var e in this.__params)this.__params[e].precalc()}},{key:"update",value:function(e){for(var t in this.__clock.update(e),this.loop&&(this.time<0||this.length<this.time)&&this.__clock.setTime(this.time-Math.floor(this.time/this.length)*this.length),this.__params)this.__params[t].getValue()}},{key:"__auto",value:function(e){return this.params[e].__currentValue}},{key:"version",get:function(){return this.__version}},{key:"time",get:function(){return this.__clock.time}},{key:"length",get:function(){return this.__length}},{key:"resolution",get:function(){return this.__resolution}},{key:"deltaTime",get:function(){return this.__clock.deltaTime}},{key:"isPlaying",get:function(){return this.__clock.isPlaying}},{key:"progress",get:function(){return this.time/this.length}},{key:"frame",get:function(){return this.__clock.frame?this.__clock.frame:void 0}},{key:"fps",get:function(){return this.__clock.fps?this.__clock.fps:void 0}},{key:"realtime",get:function(){return Boolean(this.__clock.realtime)}}]),e}();module.exports=Automaton,Automaton.default=Automaton;

},{"./clock":71,"./clock-frame":69,"./clock-realtime":70,"./param":103}],102:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var i=0;i<t.length;i++){var r=t[i];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,i,r){return i&&e(t.prototype,i),r&&e(t,r),t}}(),_get=function e(t,i,r){null===t&&(t=Function.prototype);var n=Object.getOwnPropertyDescriptor(t,i);if(void 0===n){var a=Object.getPrototypeOf(t);return null===a?void 0:e(a,i,r)}if("value"in n)return n.value;var s=n.get;return void 0!==s?s.call(r):void 0},_jsonCopy=require("./json-copy"),_jsonCopy2=_interopRequireDefault(_jsonCopy),_ass=require("./ass"),_ass2=_interopRequireDefault(_ass),_genId=require("./gen-id"),_genId2=_interopRequireDefault(_genId),_hasOverwrap=require("./has-overwrap"),_hasOverwrap2=_interopRequireDefault(_hasOverwrap),_mainGui=require("./main-gui"),_mainGui2=_interopRequireDefault(_mainGui),_param=require("./param"),_param2=_interopRequireDefault(_param),_vue=require("vue"),_vue2=_interopRequireDefault(_vue),_immutable=require("immutable");function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var ParamWithGUI=function(e){function t(e){_classCallCheck(this,t);var i=Object.assign({},e),r=e.automaton.length;i.data=i.data?i.data:{nodes:[{time:0,value:0,out:{time:t.DEFAULT_HANDLE_LENGTH,value:0}},{time:r,value:0,in:{time:-t.DEFAULT_HANDLE_LENGTH,value:0}}],fxs:[]};var n=_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,i));return n.__statuses=[{id:t.STATUS_ID_ISNOTUSED,level:t.STATUS_LEVEL_WARNING,message:"This param has not been used yet"}],n}return _inherits(t,_param2.default),_createClass(t,[{key:"__setStatus",value:function(e,t){if(this.__statuses){for(var i=0;i<this.__statuses.length;i++)if(this.__statuses[i].id===t.id){this.__statuses.splice(i,1);break}e&&(this.__statuses.push(t),this.__statuses.sort(function(e,t){return e.level<t.level}))}}},{key:"load",value:function(e){var i=(0,_jsonCopy2.default)(e);_get(t.prototype.__proto__||Object.getPrototypeOf(t.prototype),"load",this).call(this,i),this.__nodes.forEach(function(e){return e.$id=(0,_genId2.default)()}),this.__fxs.forEach(function(e){return e.$id=(0,_genId2.default)()})}},{key:"precalc",value:function(){var e=this;_get(t.prototype.__proto__||Object.getPrototypeOf(t.prototype),"precalc",this).call(this);var i=!1;this.__values.forEach(function(t,r){isNaN(t)&&(e.__values[r]=0,i=!0)}),this.__setStatus(i,{id:t.STATUS_ID_NANDETECTED,level:t.STATUS_LEVEL_ERROR,message:"This param has NaN value"}),this.__automaton.pokeRenderer()}},{key:"markAsUsed",value:function(){this.__setStatus(!1,{id:t.STATUS_ID_ISNOTUSED,level:t.STATUS_LEVEL_WARNING,message:"This param has not been used yet"})}},{key:"__sortNodes",value:function(){this.__nodes=this.__nodes.sort(function(e,t){return e.time-t.time})}},{key:"__getNodeIndexById",value:function(e){var t=this.__nodes.findIndex(function(t){return t.$id===e});if(-1===t)throw new Error("Searched for node id: "+e+" but not found");return t}},{key:"getNumNode",value:function(){return this.__nodes.length}},{key:"dumpNode",value:function(e){var t=this.__getNodeIndexById(e);return(0,_jsonCopy2.default)(this.__nodes[t])}},{key:"dumpNodes",value:function(){return(0,_jsonCopy2.default)(this.__nodes)}},{key:"dumpNodesWithoutId",value:function(){return this.dumpNodes().map(function(e){return delete e.$id,e})}},{key:"createNode",value:function(e,i){var r={$id:(0,_genId2.default)(),time:e,value:i,in:{time:-t.DEFAULT_HANDLE_LENGTH,value:0},out:{time:t.DEFAULT_HANDLE_LENGTH,value:0}};return this.__nodes.push(r),this.__sortNodes(),this.precalc(),r.$id}},{key:"createNodeFromData",value:function(e){var t=(0,_jsonCopy2.default)(e);return this.__nodes.push(t),this.__sortNodes(),this.precalc(),t.$id}},{key:"removeNode",value:function(e){var t=this.__getNodeIndexById(e);this.__nodes.splice(t,1),this.precalc()}},{key:"moveNode",value:function(e,t,i){var r=this.__getNodeIndexById(e),n=this.__nodes[r],a="number"==typeof t?t:n.time;a=0===r?0:r===this.__nodes.length-1?this.__automaton.length:Math.min(Math.max(a,this.__nodes[r-1].time),this.__nodes[r+1].time),n.time=a,n.value="number"==typeof i?i:n.value,this.precalc()}},{key:"moveHandle",value:function(e,t,i,r){var n=this.__getNodeIndexById(e);if(!(0===n&&!t||n===this.getNumNode()-1&&t)){var a=this.__nodes[n],s=t?a.out:a.in,o="number"==typeof i?i:s.time;o=t?Math.max(0,o):Math.min(0,o),s.time=o,s.value="number"==typeof r?r:s.value,this.precalc()}}},{key:"resetHandle",value:function(e,i){var r=this.__getNodeIndexById(e);if(!(0===r&&!i||r===this.getNumNode()-1&&i)){var n=this.__nodes[r],a=i?n.out:n.in;a.time=(i?1:-1)*t.DEFAULT_HANDLE_LENGTH,a.value=0,this.precalc()}}},{key:"__sortFxs",value:function(){this.__fxs=this.__fxs.sort(function(e,t){return e.time-t.time}).sort(function(e,t){return e.row-t.row})}},{key:"__getFxIndexById",value:function(e){var t=this.__fxs.findIndex(function(t){return t.$id===e});if(-1===t)throw new Error("Searched for fx id: "+e+" but not found");return t}},{key:"__getFreeRow",value:function(e,t,i){for(var r=i||0,n=0;n<this.__fxs.length;n++){var a=this.__fxs[n];if(!(a.row<r)){if(r<a.row)break;(0,_hasOverwrap2.default)(e,t,a.time,a.length)&&r++}}return r}},{key:"dumpFx",value:function(e){var t=this.__getFxIndexById(e);return(0,_jsonCopy2.default)(this.__fxs[t])}},{key:"dumpFxs",value:function(){return(0,_jsonCopy2.default)(this.__fxs)}},{key:"dumpFxsWithoutId",value:function(){return this.dumpFxs().map(function(e){return delete e.$id,e})}},{key:"createFx",value:function(e,i,r){var n=this.__getFreeRow(e,i);if(t.FX_ROW_MAX<n)return console.error("Too many fx stacks at here!"),"";var a={$id:(0,_genId2.default)(),time:e,length:i,row:n,def:r,params:this.__automaton.generateDefaultFxParams(r)};return this.__fxs.push(a),this.__sortFxs(),this.precalc(),a.$id}},{key:"createFxFromData",value:function(e){var i=this.__getFreeRow(e.time,e.length,e.row);if(t.FX_ROW_MAX<i)return console.error("Too many fx stacks at here!"),"";var r=(0,_jsonCopy2.default)(e);return r.row=i,this.__fxs.push(r),this.__sortFxs(),this.precalc(),r.$id}},{key:"removeFx",value:function(e){var t=this.__getFxIndexById(e);this.__fxs.splice(t,1),this.precalc()}},{key:"moveFx",value:function(e,t){var i=this.__getFxIndexById(e),r=this.__fxs[i],n=this.__fxs.filter(function(e){return e.row===r.row}),a=n.indexOf(r),s=n[a-1],o=n[a+1],_=s?s.time+s.length:0,u=o?o.time:this.__automaton.length;r.time=Math.min(Math.max(t,_),u-r.length),this.precalc()}},{key:"changeFxRow",value:function(e,i){var r=this.__getFxIndexById(e);if(i<0||t.FX_ROW_MAX<i)throw new Error("Row number "+i+" is invalid");var n=this.__fxs[r];n.row!==i&&(this.__fxs.filter(function(e){return e.row===i}).every(function(e){return!(e.time<n.time&&n.time<e.time+e.length||e.time<n.time+n.length&&n.time+n.length<e.time+e.length||n.time<e.time&&e.time<n.time+n.length||n.time<e.time+e.length&&e.time+e.length<n.time+n.length)})&&(n.row=i,this.__sortFxs(),this.precalc()))}},{key:"bypassFx",value:function(e,t){var i=this.__getFxIndexById(e),r=this.__fxs[i];_vue2.default.set(r,"bypass",!!t),this.precalc()}},{key:"changeFxParam",value:function(e,t,i){var r=this.__getFxIndexById(e),n=this.__fxs[r],a=this.__automaton.getFxDefinitionParams(n.def),s=i;"number"==typeof a[t].min&&(s=Math.max(a[t].min,s)),"number"==typeof a[t].max&&(s=Math.min(a[t].max,s)),_vue2.default.set(n.params,t,s),this.precalc()}},{key:"forceMoveFx",value:function(e,t,i){var r=this.__getFxIndexById(e),n=this.__fxs[r];n.time=t,n.row=i,this.__sortFxs(),this.precalc()}},{key:"resizeFx",value:function(e,t){var i=this.__getFxIndexById(e),r=this.__fxs[i],n=this.__fxs.filter(function(e){return e.row===r.row}),a=n[n.indexOf(r)+1],s=a?a.time:this.__automaton.length;r.length=Math.min(Math.max(t,0),s-r.time),this.precalc()}},{key:"resizeFxByLeft",value:function(e,t){var i=this.__getFxIndexById(e),r=this.__fxs[i],n=r.time+r.length,a=this.__fxs.filter(function(e){return e.row===r.row}),s=a[a.indexOf(r)-1],o=s?s.time+s.length:0;r.length=Math.min(Math.max(t,0),n-o),r.time=n-r.length,this.precalc()}},{key:"changeLength",value:function(e){for(var i=this.__nodes.length-1;0<=i;i--){var r=this.__nodes[i];if(!(e<r.time)){if(r.time===e){delete r.out;break}var n=this.__nodes[this.__nodes.length-1];n&&(n.out={time:t.DEFAULT_HANDLE_LENGTH,value:0}),this.__nodes.push({time:e,value:0,in:{time:-t.DEFAULT_HANDLE_LENGTH,value:0}});break}this.__nodes.splice(i,1)}for(var a=this.__fxs.length-1;0<=a;a--){var s=this.__fxs[a];e<s.time?this.__fxs.splice(a,1):e<s.time+s.length&&(s.length=e-s.time)}this.__values=new Float32Array(this.__automaton.resolution*e+1),this.precalc()}},{key:"status",get:function(){return 0===this.__statuses.length?{id:t.STATUS_ID_OK,level:t.STATUS_LEVEL_OK,message:null}:this.__statuses[0]}}]),t}();ParamWithGUI.DEFAULT_HANDLE_LENGTH=.5,ParamWithGUI.FX_ROW_MAX=4,ParamWithGUI.STATUS_LEVEL_OK=0,ParamWithGUI.STATUS_LEVEL_WARNING=1,ParamWithGUI.STATUS_LEVEL_ERROR=2,ParamWithGUI.STATUS_ID_OK=0,ParamWithGUI.STATUS_ID_ISNOTUSED=1,ParamWithGUI.STATUS_ID_NANDETECTED=2,exports.default=ParamWithGUI;

},{"./ass":68,"./gen-id":85,"./has-overwrap":86,"./json-copy":99,"./main-gui":100,"./param":103,"immutable":62,"vue":66}],103:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function t(t,e){for(var a=0;a<e.length;a++){var i=e[a];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,a,i){return a&&t(e.prototype,a),i&&t(e,i),e}}(),_cubicBezier=require("./cubic-bezier"),_cubicBezier2=_interopRequireDefault(_cubicBezier),_main=require("./main"),_main2=_interopRequireDefault(_main);function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}var Param=function(){function t(e){_classCallCheck(this,t),this.__automaton=e.automaton,this.__values=new Float32Array(this.__automaton.resolution*this.__automaton.length+1),this.load(e.data),this.__lastValue=0,this.__lastTime=0}return _createClass(t,[{key:"load",value:function(t){this.__nodes=t.nodes,this.__fxs=t.fxs,this.precalc()}},{key:"precalc",value:function(){for(var t=0;t<this.__nodes.length-1;t++){var e=this.__nodes[t],a=this.__nodes[t+1],i=Math.floor(e.time*this.__automaton.resolution),o=Math.floor(a.time*this.__automaton.resolution);this.__values[i]=e.value;for(var s=i+1;s<=o;s++){var n=s/this.__automaton.resolution,_=(0,_cubicBezier2.default)(e,a,n);this.__values[s]=_}}for(var r=0;r<this.__fxs.length;r++){var u=this.__fxs[r];if(!u.bypass){var l=this.__automaton.__paramFxDefs[u.def];if(l){for(var h=Math.ceil(this.__automaton.resolution*u.time),f=Math.floor(this.__automaton.resolution*(u.time+u.length)),m=new Float32Array(f-h),c=m.length,v={i0:h,i1:f,t0:u.time,t1:u.time+u.length,deltaTime:1/this.__automaton.resolution,dt:1/this.__automaton.resolution,resolution:this.__automaton.resolution,length:u.length,params:u.params,array:this.__values,getValue:this.getValue.bind(this),init:!0},d=0;d<c;d++)v.i=v.index=d+h,v.t=v.time=v.i/this.__automaton.resolution,v.v=v.value=this.__values[d+h],v.p=v.progress=(v.t-u.time)/u.length,m[d]=l.func(v),v.init=!1;this.__values.set(m,h)}}}}},{key:"getValue",value:function(t){var e=t;if("number"!=typeof e&&(e=this.__automaton.time),e===this.__lastTime)return this.__lastValue;if(this.__automaton.loop&&(e-=Math.floor(e/this.__automaton.length)*this.__automaton.length),e<=0)return this.__values[0];if(this.__automaton.length<=e)return this.__values[this.__values.length-1];var a=e*this.__automaton.resolution,i=Math.floor(a),o=a%1,s=this.__values[i],n=s+(this.__values[i+1]-s)*o;return this.__lastTime=e,this.__lastValue=n,n}}]),t}();exports.default=Param;

},{"./cubic-bezier":73,"./main":101}],104:[function(require,module,exports){
var __vueify_style_dispose__=require("vueify/lib/insert-css").insert("/* line 56, stdin */\n.blur-layer[data-v-a58e688a] {\n  position: absolute;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  background: #00000066; }\n\n/* line 66, stdin */\n.root[data-v-a58e688a] {\n  position: absolute;\n  left: calc( 50% - 17em);\n  top: 1em;\n  width: 30em;\n  padding: 1em;\n  overflow: hidden;\n  background: #2c3236;\n  border-radius: 0.5em;\n  color: #c9e2ff;\n  font-size: 0.8em;\n  line-height: 1.2;\n  filter: drop-shadow(0 0 2px #000000); }\n  /* line 82, stdin */\n  .root a[data-v-a58e688a] {\n    color: #22aaff;\n    text-decoration: none; }\n    /* line 86, stdin */\n    .root a[data-v-a58e688a]:hover {\n      opacity: 0.7; }\n  /* line 89, stdin */\n  .root .logo-bg[data-v-a58e688a] {\n    position: absolute;\n    right: -1em;\n    bottom: -1em;\n    width: 14em;\n    opacity: 0.07; }\n  /* line 98, stdin */\n  .root .content[data-v-a58e688a] {\n    position: relative; }\n    /* line 101, stdin */\n    .root .content .logo[data-v-a58e688a] {\n      width: 20em;\n      margin-bottom: 0.3em; }\n    /* line 106, stdin */\n    .root .content .version[data-v-a58e688a] {\n      display: inline-block;\n      vertical-align: bottom;\n      margin-left: 4px;\n      margin-bottom: 0.3em; }\n    /* line 113, stdin */\n    .root .content .logo-hr[data-v-a58e688a] {\n      width: 100%;\n      height: 1px;\n      margin: 0.5em 0;\n      background: #bad0eb; }\n  /* line 122, stdin */\n  .root .close[data-v-a58e688a] {\n    position: absolute;\n    right: 0.5em;\n    top: 0.5em;\n    width: 1em;\n    cursor: pointer; }\n    /* line 130, stdin */\n    .root .close[data-v-a58e688a]:hover {\n      opacity: 0.7; }");!function(){"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default={name:"about",props:["automaton"],data:function(){return{}},methods:{blur:function(){this.$emit("blur")}}}}(),module.exports.__esModule&&(module.exports=module.exports.default);var __vue__options__="function"==typeof module.exports?module.exports.options:module.exports;__vue__options__.functional&&console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions."),__vue__options__.render=function(){var t=this,e=t.$createElement,n=t._self._c||e;return n("div",[n("div",{staticClass:"blur-layer",on:{mousedown:t.blur}}),t._v(" "),n("div",{staticClass:"root"},[n("img",{staticClass:"logo-bg",attrs:{src:require("../images/automaton-a.svg")}}),t._v(" "),n("img",{staticClass:"close",attrs:{src:require("../images/about-close.svg")},on:{mousedown:t.blur}}),t._v(" "),n("div",{staticClass:"content"},[n("img",{staticClass:"logo",attrs:{src:require("../images/automaton.svg")}}),t._v(" "),n("div",{staticClass:"version"},[t._v(t._s(t.automaton.version))]),n("br"),t._v("\n      Animation engine with Timeline GUI for creative coding\n\n      "),n("div",{staticClass:"logo-hr"}),t._v("\n      \n      Author: "),n("a",{attrs:{href:"https://github.com/fms-cat/",target:"_blank"}},[t._v("@FMS_Cat")]),n("br"),t._v("\n      Repository: "),n("a",{attrs:{href:"https://github.com/fms-cat/automaton/",target:"_blank"}},[t._v("https://github.com/fms-cat/automaton/")]),n("br"),t._v("\n      Automaton is distributed under permissive "),n("a",{attrs:{href:"https://opensource.org/licenses/MIT",target:"_blank"}},[t._v("MIT License")]),t._v("."),n("br"),t._v("\n      Shoutouts to "),n("a",{attrs:{href:"https://www.image-line.com/flstudio/",target:"_blank"}},[t._v("Image Line Software")]),t._v(" <3\n    ")])])])},__vue__options__.staticRenderFns=[],__vue__options__._scopeId="data-v-a58e688a",module.hot&&function(){var t=require("vue-hot-reload-api");t.install(require("vue"),!0),t.compatible&&(module.hot.accept(),module.hot.dispose(__vueify_style_dispose__),module.hot.data?t.rerender("data-v-a58e688a",__vue__options__):t.createRecord("data-v-a58e688a",__vue__options__))}();

},{"../images/about-close.svg":87,"../images/automaton-a.svg":88,"../images/automaton.svg":89,"vue":66,"vue-hot-reload-api":65,"vueify/lib/insert-css":67}],105:[function(require,module,exports){
var __vueify_style_dispose__=require("vueify/lib/insert-css").insert("/* line 81, stdin */\n.blur-layer[data-v-51bc19ff] {\n  position: fixed;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%; }\n\n/* line 89, stdin */\n.root[data-v-51bc19ff] {\n  position: fixed;\n  white-space: nowrap;\n  padding: 0.4em;\n  font-size: 0.8em;\n  background: rgba(0, 0, 0, 0.5);\n  border: solid 1px #3d4449;\n  color: #bad0eb;\n  border-radius: 0.2em;\n  filter: drop-shadow(0 0 2px #000000); }\n  /* line 102, stdin */\n  .root .command[data-v-51bc19ff] {\n    padding-left: 0.2em;\n    padding-right: 2em;\n    border-radius: 0.2em;\n    cursor: pointer; }\n    /* line 110, stdin */\n    .root .command[data-v-51bc19ff]:hover {\n      background: #3d4449;\n      color: #c9e2ff; }");!function(){"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default={name:"context-menu",props:["active","x","y","commands"],data:function(){return{left:0,right:0,top:0,bottom:0}},methods:{blur:function(){this.$emit("blur")},moveRoot:function(){var e=this.x,t=this.y,o=document.documentElement.clientWidth,n=document.documentElement.clientHeight,i=o-240<e,r=n-40<t;this.left=i?null:e,this.right=i?o-e:null,this.top=r?null:t,this.bottom=r?n-t:null},selectCommand:function(e){this.commands[e].func(),this.$emit("blur")}},watch:{x:function(){this.moveRoot()},y:function(){this.moveRoot()}}}}(),module.exports.__esModule&&(module.exports=module.exports.default);var __vue__options__="function"==typeof module.exports?module.exports.options:module.exports;__vue__options__.functional&&console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions."),__vue__options__.render=function(){var e=this,t=e.$createElement,o=e._self._c||t;return o("div",[e.active?o("div",{staticClass:"blur-layer",on:{mousedown:e.blur}}):e._e(),e._v(" "),e.active?o("div",{staticClass:"root",style:{left:"number"==typeof e.left?e.left+"px":void 0,right:"number"==typeof e.right?e.right+"px":void 0,top:"number"==typeof e.top?e.top+"px":void 0,bottom:"number"==typeof e.bottom?e.bottom+"px":void 0}},e._l(e.commands,function(t,n){return o("div",{key:"command"+n,staticClass:"command",on:{mouseup:function(t){e.selectCommand(n)}}},[e._v(e._s(t.text))])})):e._e()])},__vue__options__.staticRenderFns=[],__vue__options__._scopeId="data-v-51bc19ff",module.hot&&function(){var e=require("vue-hot-reload-api");e.install(require("vue"),!0),e.compatible&&(module.hot.accept(),module.hot.dispose(__vueify_style_dispose__),module.hot.data?e.rerender("data-v-51bc19ff",__vue__options__):e.createRecord("data-v-51bc19ff",__vue__options__))}();

},{"vue":66,"vue-hot-reload-api":65,"vueify/lib/insert-css":67}],106:[function(require,module,exports){
var __vueify_style_dispose__=require("vueify/lib/insert-css").insert("/* line 155, stdin */\n.root[data-v-1d1a854f] {\n  position: absolute;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  background: #3d4449; }\n  /* line 164, stdin */\n  .root .row[data-v-1d1a854f] {\n    position: absolute;\n    height: calc( 100% - 0.25em);\n    margin: 0.125em; }\n    /* line 169, stdin */\n    .root .row.row-center[data-v-1d1a854f] {\n      width: calc( 100% - 0.25em);\n      text-align: center; }\n    /* line 173, stdin */\n    .root .row.row-left[data-v-1d1a854f] {\n      left: 0.125em; }\n    /* line 174, stdin */\n    .root .row.row-right[data-v-1d1a854f] {\n      right: 0.125em; }\n    /* line 176, stdin */\n    .root .row > *[data-v-1d1a854f] {\n      display: inline-block;\n      position: relative;\n      vertical-align: bottom;\n      margin: 0 0.125em;\n      height: 100%; }\n    /* line 184, stdin */\n    .root .row .logobox[data-v-1d1a854f] {\n      color: #c9e2ff;\n      opacity: 0.5;\n      cursor: pointer; }\n      /* line 190, stdin */\n      .root .row .logobox[data-v-1d1a854f]:hover {\n        opacity: 0.8; }\n      /* line 192, stdin */\n      .root .row .logobox .logo[data-v-1d1a854f] {\n        display: inline-block;\n        position: relative;\n        height: 60%;\n        top: 20%; }\n    /* line 200, stdin */\n    .root .row .button[data-v-1d1a854f] {\n      height: 100%;\n      cursor: pointer; }\n      /* line 205, stdin */\n      .root .row .button[data-v-1d1a854f]:hover {\n        opacity: 0.7; }\n    /* line 208, stdin */\n    .root .row .time[data-v-1d1a854f] {\n      width: 8em;\n      white-space: nowrap;\n      text-align: right;\n      cursor: pointer; }\n      /* line 216, stdin */\n      .root .row .time *[data-v-1d1a854f] {\n        pointer-events: none; }\n      /* line 220, stdin */\n      .root .row .time .current[data-v-1d1a854f] {\n        position: relative;\n        font-size: 0.8em;\n        margin-right: 0;\n        color: #c9e2ff; }\n      /* line 229, stdin */\n      .root .row .time .length[data-v-1d1a854f] {\n        position: relative;\n        font-size: 0.6em;\n        margin-left: 0;\n        color: #bad0eb; }\n      /* line 237, stdin */\n      .root .row .time .bar[data-v-1d1a854f] {\n        display: block;\n        position: absolute;\n        bottom: 0.25em;\n        left: 0px;\n        height: 2px;\n        margin: 0; }\n        /* line 245, stdin */\n        .root .row .time .bar.bar-bg[data-v-1d1a854f] {\n          background: #000000; }\n        /* line 246, stdin */\n        .root .row .time .bar.bar-fg[data-v-1d1a854f] {\n          background: #c9e2ff; }\n      /* line 250, stdin */\n      .root .row .time:hover .bar-fg[data-v-1d1a854f] {\n        background: #22aaff; }\n      /* line 254, stdin */\n      .root .row .time.seeking .bar-fg[data-v-1d1a854f] {\n        background: #22aaff; }");!function(){"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default={mounted:function(){},beforeDestroy:function(){},props:["automaton"],data:function(){return{saveText:"Copy current state as JSON",seeking:!1,cantUndoThis:0}},methods:{seek:function(t){var o=this,n=t.target.offsetWidth,e=t.offsetX,a=t.clientX,i=this.automaton.isPlaying;i&&this.automaton.pause(),this.automaton.seek(this.automaton.length*e/n),this.seeking=!0;var s=function(t){var i=e+t.clientX-a;o.automaton.seek(o.automaton.length*i/n)};window.addEventListener("mousemove",s),window.addEventListener("mouseup",function t(n){i&&o.automaton.play(),o.seeking=!1,window.removeEventListener("mousemove",s),window.removeEventListener("mouseup",t)})},undo:function(){this.automaton.getUndoDesc()?(this.automaton.undo(),this.cantUndoThis=0):(this.cantUndoThis++,10===this.cantUndoThis&&(window.open("https://youtu.be/bzY7J0Xle08","_blank"),this.cantUndoThis=0)),this.$emit("historyMoved")},redo:function(){this.automaton.redo(),this.$emit("historyMoved")},save:function(){var t=this,o=document.createElement("textarea");o.value=this.automaton.save(),document.body.appendChild(o),o.select(),document.execCommand("copy"),document.body.removeChild(o),this.saveText="Copied!",setTimeout(function(){t.saveText="Copy current state as JSON"},3e3)}}}}(),module.exports.__esModule&&(module.exports=module.exports.default);var __vue__options__="function"==typeof module.exports?module.exports.options:module.exports;__vue__options__.functional&&console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions."),__vue__options__.render=function(){var t=this,o=t.$createElement,n=t._self._c||o;return n("div",[n("div",{staticClass:"root"},[n("div",{staticClass:"row row-center"},[n("div",{staticClass:"logobox",on:{click:function(o){o.stopPropagation(),t.$emit("logoClicked")}}},[n("img",{staticClass:"logo",attrs:{src:require("../images/automaton.svg")}})])]),t._v(" "),n("div",{staticClass:"row row-left"},[n("img",{staticClass:"button",attrs:{src:t.automaton.isPlaying?require("../images/pause.svg"):require("../images/play.svg")},on:{click:function(o){o.stopPropagation(),t.automaton.togglePlay()}}}),t._v(" "),n("div",{staticClass:"time",class:{seeking:t.seeking},on:{mousedown:function(o){return o.stopPropagation(),t.seek(o)}}},[n("span",{staticClass:"current"},[t._v(t._s(t.automaton.time.toFixed(3)))]),t._v(" "),n("span",{staticClass:"length"},[t._v(" / "+t._s(t.automaton.length.toFixed(3)))]),t._v(" "),n("div",{staticClass:"bar bar-bg",style:{width:"100%"}}),t._v(" "),n("div",{staticClass:"bar bar-fg",style:{width:100*t.automaton.progress+"%"}})])]),t._v(" "),n("div",{staticClass:"row row-right"},[n("img",{staticClass:"button",attrs:{src:require("../images/undo.svg"),"stalker-text":t.automaton.getUndoDesc()?"Undo: "+t.automaton.getUndoDesc():"Can't undo"},on:{click:function(o){o.stopPropagation(),t.undo()}}}),t._v(" "),n("img",{staticClass:"button",attrs:{src:require("../images/redo.svg"),"stalker-text":t.automaton.getRedoDesc()?"Redo: "+t.automaton.getRedoDesc():"Can't redo"},on:{click:function(o){o.stopPropagation(),t.redo()}}}),t._v(" "),n("img",{staticClass:"button",attrs:{src:require("../images/snap.svg"),"stalker-text":"Snap Settings"},on:{click:function(o){o.stopPropagation(),t.$emit("configSelected","snap")}}}),t._v(" "),n("img",{staticClass:"button",attrs:{src:require("../images/cog.svg"),"stalker-text":"General Config"},on:{click:function(o){o.stopPropagation(),t.$emit("configSelected","general")}}}),t._v(" "),n("img",{staticClass:"button",attrs:{src:require("../images/save.svg"),"stalker-text":t.saveText},on:{click:function(o){return o.stopPropagation(),t.save(o)}}})])])])},__vue__options__.staticRenderFns=[],__vue__options__._scopeId="data-v-1d1a854f",module.hot&&function(){var t=require("vue-hot-reload-api");t.install(require("vue"),!0),t.compatible&&(module.hot.accept(),module.hot.dispose(__vueify_style_dispose__),module.hot.data?t.rerender("data-v-1d1a854f",__vue__options__):t.createRecord("data-v-1d1a854f",__vue__options__))}();

},{"../images/automaton.svg":89,"../images/cog.svg":90,"../images/pause.svg":92,"../images/play.svg":93,"../images/redo.svg":94,"../images/save.svg":95,"../images/snap.svg":96,"../images/undo.svg":97,"vue":66,"vue-hot-reload-api":65,"vueify/lib/insert-css":67}],107:[function(require,module,exports){
var __vueify_style_dispose__=require("vueify/lib/insert-css").insert("@import url(\"https://fonts.googleapis.com/css?family=Roboto:300,400,500,700,900\");\n/* line 142, stdin */\n.automaton {\n  font-family: 'Roboto', sans-serif;\n  font-weight: 300;\n  font-size: 16px; }\n/* line 152, stdin */\n.root[data-v-205ed4fb] {\n  user-select: none; }\n  /* line 156, stdin */\n  .root .header[data-v-205ed4fb] {\n    position: absolute;\n    left: 0;\n    top: 0;\n    width: 100%;\n    height: 2em; }\n  /* line 165, stdin */\n  .root .paramlist[data-v-205ed4fb] {\n    position: absolute;\n    left: 0;\n    top: 2em;\n    width: 8em;\n    height: calc( 100% - 2em); }\n  /* line 174, stdin */\n  .root .propmenu[data-v-205ed4fb] {\n    position: absolute;\n    right: 0;\n    top: 2em;\n    width: 12em;\n    height: calc( 100% - 2em); }\n  /* line 182, stdin */\n  .root .timeline[data-v-205ed4fb] {\n    position: absolute;\n    left: 8em;\n    top: 2em;\n    width: calc( 100% - 20em);\n    height: calc( 100% - 2em); }");!function(){"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=u(require("./about.vue")),t=u(require("./header.vue")),o=u(require("./paramlist.vue")),n=u(require("./propmenu.vue")),s=u(require("./timeline.vue")),a=u(require("./context-menu.vue")),i=u(require("./stalker.vue"));function u(e){return e&&e.__esModule?e:{default:e}}exports.default={components:{About:e.default,Header:t.default,ParamList:o.default,PropMenu:n.default,Timeline:s.default,ContextMenu:a.default,Stalker:i.default},props:["automaton"],data:function(){return{aboutActive:!1,selectedParamName:null,selectedNodeIds:[],selectedFxIds:[],config:"",contextMenuActive:!1,contextMenuX:0,contextMenuY:0,contextMenuCommands:[]}},methods:{selectParam:function(e){this.selectedParamName=e,this.selectNodes([]),this.selectFxs([])},selectNodes:function(e){this.selectedNodeIds=e,this.config=""},selectFxs:function(e){this.selectedFxIds=e,this.config=""},onHistoryMoved:function(){this.selectNodes([]),this.selectFxs([])},onConfigSelected:function(e){this.selectNodes([]),this.selectFxs([]),this.config=e},openContextMenu:function(e){this.contextMenuActive=!0,this.contextMenuX=e.clientX,this.contextMenuY=e.clientY,this.contextMenuCommands=e.commands}},mounted:function(){var e=this;this.$root.$on("loaded",function(){e.selectParam(null),e.selectNodes([]),e.selectFxs([]),e.config=""})},beforeDestroy:function(){}}}(),module.exports.__esModule&&(module.exports=module.exports.default);var __vue__options__="function"==typeof module.exports?module.exports.options:module.exports;__vue__options__.functional&&console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions."),__vue__options__.render=function(){var e=this,t=e.$createElement,o=e._self._c||t;return o("div",[o("div",{staticClass:"root automaton color-theme-dark"},[o("Header",{staticClass:"header",attrs:{automaton:e.automaton},on:{historyMoved:e.onHistoryMoved,configSelected:e.onConfigSelected,context:e.openContextMenu,logoClicked:function(t){e.aboutActive=!0}}}),e._v(" "),o("ParamList",{staticClass:"paramlist",attrs:{automaton:e.automaton,selectedParamName:e.selectedParamName},on:{selected:function(t){e.selectParam(t)},context:e.openContextMenu}}),e._v(" "),o("PropMenu",{staticClass:"propmenu",attrs:{automaton:e.automaton,selectedParamName:e.selectedParamName,selectedNodeIds:e.selectedNodeIds,selectedFxIds:e.selectedFxIds,config:e.config},on:{context:e.openContextMenu}}),e._v(" "),o("Timeline",{staticClass:"timeline",attrs:{automaton:e.automaton,selectedParamName:e.selectedParamName,selectedNodeIds:e.selectedNodeIds,selectedFxIds:e.selectedFxIds},on:{nodeSelected:function(t){e.selectNodes(t)},fxSelected:function(t){e.selectFxs(t)},context:e.openContextMenu}}),e._v(" "),e.aboutActive?o("About",{staticClass:"about",attrs:{automaton:e.automaton},on:{blur:function(t){e.aboutActive=!1}}}):e._e(),e._v(" "),o("ContextMenu",{staticClass:"context-menu",attrs:{active:e.contextMenuActive,x:e.contextMenuX,y:e.contextMenuY,commands:e.contextMenuCommands},on:{blur:function(t){e.contextMenuActive=!1}}}),e._v(" "),o("Stalker",{staticClass:"stalker"})],1)])},__vue__options__.staticRenderFns=[],__vue__options__._scopeId="data-v-205ed4fb",module.hot&&function(){var e=require("vue-hot-reload-api");e.install(require("vue"),!0),e.compatible&&(module.hot.accept(),module.hot.dispose(__vueify_style_dispose__),module.hot.data?e.rerender("data-v-205ed4fb",__vue__options__):e.createRecord("data-v-205ed4fb",__vue__options__))}();

},{"./about.vue":104,"./context-menu.vue":105,"./header.vue":106,"./paramlist.vue":108,"./propmenu.vue":110,"./stalker.vue":112,"./timeline.vue":114,"vue":66,"vue-hot-reload-api":65,"vueify/lib/insert-css":67}],108:[function(require,module,exports){
var __vueify_style_dispose__=require("vueify/lib/insert-css").insert("/* line 83, stdin */\n.root[data-v-e8e6ae4e] {\n  position: absolute;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  background: #202325;\n  color: #c9e2ff; }\n  /* line 93, stdin */\n  .root .param[data-v-e8e6ae4e] {\n    position: relative;\n    width: calc( 100% - 4px);\n    height: 1.25em;\n    margin: 2px;\n    background: #2c3236;\n    color: #bad0eb;\n    cursor: pointer; }\n    /* line 104, stdin */\n    .root .param.selected[data-v-e8e6ae4e] {\n      background: #3d4449;\n      color: #c9e2ff; }\n    /* line 109, stdin */\n    .root .param .name[data-v-e8e6ae4e] {\n      position: absolute;\n      left: 0.2em;\n      top: 0;\n      width: calc( 100% - 2em);\n      overflow: hidden;\n      text-overflow: ellipsis;\n      white-space: nowrap;\n      user-select: none; }\n    /* line 121, stdin */\n    .root .param .value[data-v-e8e6ae4e] {\n      position: absolute;\n      right: 0.2em;\n      bottom: 0.1em;\n      font-size: 0.6em;\n      opacity: 0.7;\n      user-select: none; }\n    /* line 132, stdin */\n    .root .param .icon[data-v-e8e6ae4e] {\n      position: absolute;\n      right: 0.1em;\n      bottom: 0.1em;\n      height: calc( 100% - 0.2em); }");!function(){"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=a(require("../param-gui")),t=a(require("./scrollable.vue"));function a(e){return e&&e.__esModule?e:{default:e}}exports.default={components:{Scrollable:t.default},props:["automaton","selectedParamName"],data:function(){return{Param:e.default}},methods:{contextParam:function(e,t){var a=this;this.$emit("context",{clientX:e.clientX,clientY:e.clientY,commands:[{text:"Select Param",func:function(){a.$emit("selected",t)}},{text:"Remove Param",func:function(){a.automaton.removeParam(t),a.$emit("selected",null)}}]})}}}}(),module.exports.__esModule&&(module.exports=module.exports.default);var __vue__options__="function"==typeof module.exports?module.exports.options:module.exports;__vue__options__.functional&&console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions."),__vue__options__.render=function(){var e=this,t=e.$createElement,a=e._self._c||t;return a("div",[a("Scrollable",{staticClass:"root",attrs:{bar:"left"}},e._l(e.automaton.getParamNames(),function(t){return a("div",{key:"param"+t,staticClass:"param",class:{selected:t===e.selectedParamName},attrs:{"stalker-text":t},on:{click:function(a){e.$emit("selected",t)},contextmenu:function(a){a.stopPropagation(),a.preventDefault(),e.contextParam(a,t)}}},[a("div",{staticClass:"name",attrs:{"stalker-text":t}},[e._v(e._s(t))]),e._v(" "),e.automaton.getParam(t).status.level===e.Param.STATUS_LEVEL_ERROR?a("img",{staticClass:"icon",attrs:{src:require("../images/error.svg"),"stalker-text":"This param has NaN value"}}):e._e(),e._v(" "),e.automaton.getParam(t).status.level===e.Param.STATUS_LEVEL_WARNING?a("img",{staticClass:"icon",attrs:{src:require("../images/warning.svg"),"stalker-text":"This param has not been used yet"}}):e._e(),e._v(" "),e.automaton.getParam(t).status.level===e.Param.STATUS_LEVEL_OK?a("div",{staticClass:"value",attrs:{"stalker-text":t}},[e._v(e._s(e.automaton.auto(t).toFixed(3)))]):e._e()])}))],1)},__vue__options__.staticRenderFns=[],__vue__options__._scopeId="data-v-e8e6ae4e",module.hot&&function(){var e=require("vue-hot-reload-api");e.install(require("vue"),!0),e.compatible&&(module.hot.accept(),module.hot.dispose(__vueify_style_dispose__),module.hot.data?e.rerender("data-v-e8e6ae4e",__vue__options__):e.createRecord("data-v-e8e6ae4e",__vue__options__))}();

},{"../images/error.svg":91,"../images/warning.svg":98,"../param-gui":102,"./scrollable.vue":111,"vue":66,"vue-hot-reload-api":65,"vueify/lib/insert-css":67}],109:[function(require,module,exports){
var __vueify_style_dispose__=require("vueify/lib/insert-css").insert("/* line 144, stdin */\n.propbox {\n  position: relative;\n  width: 100%;\n  height: 1.25em;\n  margin-bottom: 0.25em; }\n  /* line 150, stdin */\n  .propbox .name {\n    position: absolute;\n    left: 0;\n    top: 0;\n    height: 100%;\n    margin-top: 0.1em; }\n  /* line 159, stdin */\n  .propbox .value {\n    background: #2c3236;\n    cursor: pointer; }\n    /* line 162, stdin */\n    .propbox .value:active:not(.readonly) {\n      background: #0e1011; }\n    /* line 168, stdin */\n    .propbox .value.readonly {\n      cursor: not-allowed; }\n  /* line 173, stdin */\n  .propbox .number {\n    position: absolute;\n    right: 0;\n    top: 0;\n    width: 5em;\n    height: 100%; }\n    /* line 180, stdin */\n    .propbox .number .valueText {\n      width: 100%;\n      margin-top: 0.1em;\n      text-align: center; }\n      /* line 186, stdin */\n      .propbox .number .valueText.readonly {\n        opacity: 0.5; }\n    /* line 191, stdin */\n    .propbox .number .valueInput {\n      position: absolute;\n      left: 0;\n      top: 0;\n      width: 100%;\n      height: 100%;\n      border: none;\n      padding: 0;\n      text-align: center;\n      background: #4a545a;\n      color: #c9e2ff; }\n  /* line 206, stdin */\n  .propbox .boolean {\n    position: absolute;\n    right: 1.875em;\n    top: 0;\n    width: 1.25em;\n    height: 100%; }\n    /* line 213, stdin */\n    .propbox .boolean .booleanCheck {\n      position: absolute;\n      left: 20%;\n      top: 20%;\n      width: 60%;\n      height: 60%;\n      background: #22aaff; }\n      /* line 222, stdin */\n      .propbox .boolean .booleanCheck.readonly {\n        background: #687788;\n        opacity: 0.5; }");!function(){"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=t(require("babel-runtime/core-js/math/log10")),n=t(require("babel-runtime/core-js/math/sign"));function t(e){return e&&e.__esModule?e:{default:e}}exports.default={name:"propbox",props:["name","value","type","min","max","readonly"],data:function(){return{input:!1,lastClick:0}},methods:{nMousedown:function(t){var o=this;if(!this.readonly){var i=Date.now();i-this.lastClick<500&&(this.input=!0,this.$refs.valueInput.value=this.value,setTimeout(function(){o.$refs.valueInput.focus(),o.$refs.valueInput.select()},10)),this.lastClick=i;var a,s,r=t.clientY,l=r,u=Number(this.value);a=function(t){var i=Number(o.value),a=t.clientY,s=l-a;if(l=a,"int"===o.type)i=u-Math.floor((a-r)/10);else if(t.shiftKey)for(var d=Math.abs(s),p=(0,n.default)(s),v=0;v<d;v++){var c=Math.abs(i),m=(0,n.default)(i+1e-4*p),h=Math.floor((0,e.default)(c+1e-4*p*m))-1-(t.altKey?1:0);i+=Math.max(.001,Math.pow(10,h))*p}else i+=s*(t.altKey?.001:.01);o.max&&(i=Math.min(i,parseFloat(o.max))),o.min&&(i=Math.max(i,parseFloat(o.min))),i="int"===o.type?i:Number(i.toFixed(3)),o.$emit("changed",i)},s=function(e){u!==Number(o.value)&&o.$emit("finished",[u,Number(o.value)])},window.addEventListener("mousemove",a),window.addEventListener("mouseup",function e(n){"function"==typeof s&&s(n),window.removeEventListener("mousemove",a),window.removeEventListener("mouseup",e)})}},nEnter:function(e){var n=parseFloat(this.$refs.valueInput.value);"int"===this.type&&(n=Math.round(n)),this.$emit("changed",n),this.$emit("finished",[Number(this.value),n]),this.input=!1},nBlur:function(e){this.input=!1},bToggle:function(e){if(!this.readonly){var n=!this.value;this.$emit("changed",n),this.$emit("finished",[!n,n])}}}}}(),module.exports.__esModule&&(module.exports=module.exports.default);var __vue__options__="function"==typeof module.exports?module.exports.options:module.exports;__vue__options__.functional&&console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions."),__vue__options__.render=function(){var e=this,n=e.$createElement,t=e._self._c||n;return t("div",[t("div",{staticClass:"propbox"},[t("div",{staticClass:"name"},[e._v(e._s(e.name))]),e._v(" "),"float"===e.type||"int"===e.type?t("div",{staticClass:"value number",class:{readonly:e.readonly}},[t("div",{staticClass:"valueText",class:{readonly:e.readonly},on:{mousedown:e.nMousedown}},[e._v(e._s("int"===e.type?e.value:e.value.toFixed(3)))]),e._v(" "),t("input",{directives:[{name:"show",rawName:"v-show",value:e.input,expression:"input"}],ref:"valueInput",staticClass:"valueInput",on:{keydown:function(n){return"button"in n||!e._k(n.keyCode,"enter",13,n.key,"Enter")?e.nEnter(n):null},blur:e.nBlur}})]):e._e(),e._v(" "),"boolean"===e.type?t("div",{staticClass:"value boolean",class:{readonly:e.readonly},on:{click:e.bToggle}},[t("div",{directives:[{name:"show",rawName:"v-show",value:e.value,expression:"value"}],staticClass:"booleanCheck"})]):e._e()])])},__vue__options__.staticRenderFns=[],module.hot&&function(){var e=require("vue-hot-reload-api");e.install(require("vue"),!0),e.compatible&&(module.hot.accept(),module.hot.dispose(__vueify_style_dispose__),module.hot.data?e.rerender("data-v-20f8fe94",__vue__options__):e.createRecord("data-v-20f8fe94",__vue__options__))}();

},{"babel-runtime/core-js/math/log10":2,"babel-runtime/core-js/math/sign":3,"vue":66,"vue-hot-reload-api":65,"vueify/lib/insert-css":67}],110:[function(require,module,exports){
var __vueify_style_dispose__=require("vueify/lib/insert-css").insert("/* line 331, stdin */\n.root[data-v-59528d04] {\n  position: absolute;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  background: #202325;\n  color: #c9e2ff; }\n  /* line 341, stdin */\n  .root .props[data-v-59528d04] {\n    padding: 0.75em 1.5em;\n    font-size: 0.75em; }\n    /* line 345, stdin */\n    .root .props .title[data-v-59528d04] {\n      overflow: hidden;\n      text-overflow: ellipsis;\n      white-space: nowrap;\n      font-size: 1.5em;\n      color: #22aaff; }\n    /* line 354, stdin */\n    .root .props hr[data-v-59528d04] {\n      border: solid 1px #2c3236; }\n    /* line 358, stdin */\n    .root .props .centering[data-v-59528d04] {\n      text-align: center; }\n      /* line 361, stdin */\n      .root .props .centering .button-confirm[data-v-59528d04] {\n        display: inline-block;\n        width: 4em;\n        padding: 0.25em;\n        background: #2c3236;\n        cursor: pointer; }\n        /* line 370, stdin */\n        .root .props .centering .button-confirm[data-v-59528d04]:hover {\n          background: #0e1011; }\n  /* line 375, stdin */\n  .root .logobox[data-v-59528d04] {\n    position: absolute;\n    left: 0;\n    top: 0;\n    width: 100%;\n    height: 100%;\n    overflow: hidden; }\n    /* line 383, stdin */\n    .root .logobox .logo[data-v-59528d04] {\n      position: absolute;\n      width: 8em;\n      left: calc( 50% - 4em);\n      top: calc( 50% - 4em);\n      opacity: 0.1; }");!function(){"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=o(require("./propbox.vue")),t=o(require("./scrollable.vue"));function o(e){return e&&e.__esModule?e:{default:e}}exports.default={name:"propmenu",props:["automaton","selectedParamName","selectedNodeIds","selectedFxIds","config"],components:{Propbox:e.default,Scrollable:t.default},data:function(){return{generalConfigs:{length:0,resolution:0}}},methods:{confirmGeneralConfigs:function(){this.automaton.setLength(this.generalConfigs.length),this.automaton.setResolution(this.generalConfigs.resolution)}},computed:{selectedParam:function(){return this.automaton.getParam(this.selectedParamName)},selectedNodeId:function(){return 1===this.selectedNodeIds.length?this.selectedNodeIds[0]:null},selectedNode:function(){return 1===this.selectedNodeIds.length?this.selectedParam.dumpNode(this.selectedNodeId):null},selectedFxId:function(){return 1===this.selectedFxIds.length?this.selectedFxIds[0]:null},selectedFx:function(){return 1===this.selectedFxIds.length?this.selectedParam.dumpFx(this.selectedFxId):null}},watch:{config:function(){"general"===this.config&&(this.generalConfigs.length=this.automaton.length,this.generalConfigs.resolution=this.automaton.resolution)}}}}(),module.exports.__esModule&&(module.exports=module.exports.default);var __vue__options__="function"==typeof module.exports?module.exports.options:module.exports;__vue__options__.functional&&console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions."),__vue__options__.render=function(){var e=this,t=e.$createElement,o=e._self._c||t;return o("div",[o("Scrollable",{staticClass:"root",attrs:{bar:"right"}},[e.selectedNode?o("div",{staticClass:"props"},[o("div",{staticClass:"title"},[e._v("Node")]),e._v(" "),o("hr"),e._v(" "),o("Propbox",{staticClass:"prop",attrs:{type:"float",name:"Time",value:e.selectedNode.time,readonly:!(e.selectedNode.in&&e.selectedNode.out)},on:{changed:function(t){e.selectedParam.moveNode(e.selectedNodeId,t)},finished:function(t){e.automaton.pushHistory("Change Node Time",function(){e.selectedParam.moveNode(e.selectedNodeId,t[1])},function(){e.selectedParam.moveNode(e.selectedNodeId,t[0])})}}}),e._v(" "),o("Propbox",{staticClass:"prop",attrs:{type:"float",name:"Value",value:e.selectedNode.value},on:{changed:function(t){e.selectedParam.moveNode(e.selectedNodeId,void 0,t)},finished:function(t){e.automaton.pushHistory("Change Node Value",function(){e.selectedParam.moveNode(e.selectedNodeId,void 0,t[1])},function(){e.selectedParam.moveNode(e.selectedNodeId,void 0,t[0])})}}}),e._v(" "),o("hr"),e._v(" "),o("Propbox",{staticClass:"prop",attrs:{type:"float",name:"In Time",value:e.selectedNode.in?e.selectedNode.in.time:0,readonly:!e.selectedNode.in},on:{changed:function(t){e.selectedParam.moveHandle(e.selectedNodeId,!1,t)},finished:function(t){e.automaton.pushHistory("Change Node Time",function(){e.selectedParam.moveHandle(e.selectedNodeId,!1,t[1])},function(){e.selectedParam.moveHandle(e.selectedNodeId,!1,t[0])})}}}),e._v(" "),o("Propbox",{staticClass:"prop",attrs:{type:"float",name:"In Value",value:e.selectedNode.in?e.selectedNode.in.value:0,readonly:!e.selectedNode.in},on:{changed:function(t){e.selectedParam.moveHandle(e.selectedNodeId,!1,void 0,t)},finished:function(t){e.automaton.pushHistory("Change Node Value",function(){e.selectedParam.moveHandle(e.selectedNodeId,!1,void 0,t[1])},function(){e.selectedParam.moveHandle(e.selectedNodeId,!1,void 0,t[0])})}}}),e._v(" "),o("hr"),e._v(" "),o("Propbox",{staticClass:"prop",attrs:{type:"float",name:"Out Time",value:e.selectedNode.out?e.selectedNode.out.time:0,readonly:!e.selectedNode.out},on:{changed:function(t){e.selectedParam.moveHandle(e.selectedNodeId,!0,t)},finished:function(t){e.automaton.pushHistory("Change Node Time",function(){e.selectedParam.moveHandle(e.selectedNodeId,!0,t[1])},function(){e.selectedParam.moveHandle(e.selectedNodeId,!0,t[0])})}}}),e._v(" "),o("Propbox",{staticClass:"prop",attrs:{type:"float",name:"Out Value",value:e.selectedNode.out?e.selectedNode.out.value:0,readonly:!e.selectedNode.out},on:{changed:function(t){e.selectedParam.moveHandle(e.selectedNodeId,!0,void 0,t)},finished:function(t){e.automaton.pushHistory("Change Node Value",function(){e.selectedParam.moveHandle(e.selectedNodeId,!0,void 0,t[1])},function(){e.selectedParam.moveHandle(e.selectedNodeId,!0,void 0,t[0])})}}})],1):e._e(),e._v(" "),e.selectedFx?o("div",{staticClass:"props"},[o("div",{staticClass:"title"},[e._v("Fx: "+e._s(e.automaton.getFxDefinitionName(e.selectedFx.def)))]),e._v(" "),o("hr"),e._v(" "),o("Propbox",{staticClass:"prop",attrs:{type:"float",name:"Time",value:e.selectedFx.time},on:{changed:function(t){e.selectedParam.moveFx(e.selectedFxId,t)},finished:function(t){e.automaton.pushHistory("Move Fx",function(){e.selectedParam.moveFx(e.selectedFxId,t[1])},function(){e.selectedParam.moveFx(e.selectedFxId,t[0])})}}}),e._v(" "),o("Propbox",{staticClass:"prop",attrs:{type:"float",name:"Length",value:e.selectedFx.length},on:{changed:function(t){e.selectedParam.resizeFx(e.selectedFxId,t)},finished:function(t){e.automaton.pushHistory("Move Fx",function(){e.selectedParam.resizeFx(e.selectedFxId,t[1])},function(){e.selectedParam.resizeFx(e.selectedFxId,t[0])})}}}),e._v(" "),o("Propbox",{staticClass:"prop",attrs:{type:"boolean",name:"Bypass",value:e.selectedFx.bypass},on:{finished:function(t){e.automaton.pushHistory("Toggle Bypass Fx",function(){e.selectedParam.bypassFx(e.selectedFxId,t[1])},function(){e.selectedParam.bypassFx(e.selectedFxId,t[0])},!0)}}}),e._v(" "),o("hr"),e._v(" "),e._l(e.automaton.getFxDefinitionParams(e.selectedFx.def),function(t,n){return o("Propbox",{key:"fxParam-"+n,staticClass:"prop",attrs:{type:t.type,name:t.name||n,value:e.selectedFx.params[n]},on:{changed:function(t){e.selectedParam.changeFxParam(e.selectedFxId,n,t)},finished:function(t){e.automaton.pushHistory("Change Fx Param",function(){e.selectedParam.changeFxParam(e.selectedFxId,n,t[1])},function(){e.selectedParam.changeFxParam(e.selectedFxId,n,t[0])})}}})})],2):e._e(),e._v(" "),"snap"===e.config?o("div",{staticClass:"props"},[o("div",{staticClass:"title"},[e._v("Snap Settings")]),e._v(" "),o("hr"),e._v(" "),o("Propbox",{staticClass:"prop",attrs:{name:"Enable Snap",type:"boolean",value:e.automaton.guiSettings.snapActive},on:{changed:function(t){e.automaton.guiSettings.snapActive=t}}}),e._v(" "),o("Propbox",{staticClass:"prop",attrs:{name:"Interval (Time)",min:"0.0",type:"float",value:e.automaton.guiSettings.snapTime},on:{changed:function(t){e.automaton.guiSettings.snapTime=t}}}),e._v(" "),o("Propbox",{staticClass:"prop",attrs:{name:"Interval (Value)",min:"0.0",type:"float",value:e.automaton.guiSettings.snapValue},on:{changed:function(t){e.automaton.guiSettings.snapValue=t}}})],1):e._e(),e._v(" "),"general"===e.config?o("div",{staticClass:"props"},[o("div",{staticClass:"title"},[e._v("General Config")]),e._v(" "),o("hr"),e._v(" "),o("Propbox",{staticClass:"prop",attrs:{name:"Length",type:"float",min:"0",value:e.generalConfigs.length},on:{changed:function(t){e.generalConfigs.length=t}}}),e._v(" "),o("Propbox",{staticClass:"prop",attrs:{name:"Resolution",type:"int",min:"1",value:e.generalConfigs.resolution},on:{changed:function(t){e.generalConfigs.resolution=t}}}),e._v(" "),o("hr"),e._v(" "),o("div",{staticClass:"centering"},[e._v("\n        This cannot be undone!\n        "),o("div",{staticClass:"button-confirm",on:{click:e.confirmGeneralConfigs}},[e._v("Apply")])])],1):e._e()]),e._v(" "),e.selectedNode||e.selectedFx||e.config?e._e():o("div",{staticClass:"logobox"},[o("img",{staticClass:"logo",attrs:{src:require("../images/automaton-a.svg")}})])],1)},__vue__options__.staticRenderFns=[],__vue__options__._scopeId="data-v-59528d04",module.hot&&function(){var e=require("vue-hot-reload-api");e.install(require("vue"),!0),e.compatible&&(module.hot.accept(),module.hot.dispose(__vueify_style_dispose__),module.hot.data?e.rerender("data-v-59528d04",__vue__options__):e.createRecord("data-v-59528d04",__vue__options__))}();

},{"../images/automaton-a.svg":88,"./propbox.vue":109,"./scrollable.vue":111,"vue":66,"vue-hot-reload-api":65,"vueify/lib/insert-css":67}],111:[function(require,module,exports){
var __vueify_style_dispose__=require("vueify/lib/insert-css").insert("/* line 87, stdin */\n.root[data-v-6867232e] {\n  position: relative;\n  width: 100%;\n  height: 100%;\n  overflow: hidden; }\n  /* line 93, stdin */\n  .root .inside[data-v-6867232e] {\n    position: absolute;\n    left: 0;\n    width: 100%; }\n  /* line 99, stdin */\n  .root .bar[data-v-6867232e] {\n    position: absolute;\n    width: 4px;\n    background: #22aaff;\n    border-radius: 2px; }");!function(){"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default={props:["bar"],data:function(){return{top:0,barOpacity:0,observer:null}},methods:{onWheel:function(e){e.preventDefault(),this.top=this.top-e.deltaY;var t=this.$refs.inside.clientHeight-this.$refs.root.clientHeight;this.top<-t&&(this.top=Math.min(0,-t)),0<this.top&&(this.top=0),this.barHeight=100*this.$refs.root.clientHeight/this.$refs.inside.clientHeight,this.barTop=-100*this.top/this.$refs.inside.clientHeight,this.barOpacity+=Math.min(this.barOpacity+.1*Math.abs(e.deltaY),1)}},mounted:function(){var e=this;this.observer=new MutationObserver(function(t,i){var o=e.$refs.inside.clientHeight-e.$refs.root.clientHeight;e.top<-o&&(e.top=Math.min(0,-o))}),this.observer.observe(this.$refs.inside,{childList:!0,subtree:!0});!function t(){e.barOpacity*=.9,requestAnimationFrame(t)}()},beforeDestroy:function(){this.observer.disconnect()}}}(),module.exports.__esModule&&(module.exports=module.exports.default);var __vue__options__="function"==typeof module.exports?module.exports.options:module.exports;__vue__options__.functional&&console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions."),__vue__options__.render=function(){var e=this,t=e.$createElement,i=e._self._c||t;return i("div",[i("div",{ref:"root",staticClass:"root",on:{wheel:function(t){return t.stopPropagation(),e.onWheel(t)}}},[i("div",{ref:"inside",staticClass:"inside",style:{top:e.top+"px"}},[e._t("default")],2),e._v(" "),i("div",{staticClass:"bar",style:{top:e.barTop+"%",height:e.barHeight+"%",left:"left"===e.bar?0:void 0,right:"right"===e.bar?0:void 0,opacity:e.barOpacity}})])])},__vue__options__.staticRenderFns=[],__vue__options__._scopeId="data-v-6867232e",module.hot&&function(){var e=require("vue-hot-reload-api");e.install(require("vue"),!0),e.compatible&&(module.hot.accept(),module.hot.dispose(__vueify_style_dispose__),module.hot.data?e.rerender("data-v-6867232e",__vue__options__):e.createRecord("data-v-6867232e",__vue__options__))}();

},{"vue":66,"vue-hot-reload-api":65,"vueify/lib/insert-css":67}],112:[function(require,module,exports){
var __vueify_style_dispose__=require("vueify/lib/insert-css").insert("/* line 71, stdin */\n.root[data-v-b396708c] {\n  position: fixed;\n  pointer-events: none;\n  white-space: nowrap;\n  padding: 0.2em 0.4em;\n  margin: 10px;\n  font-size: 0.8em;\n  background: rgba(0, 0, 0, 0.8);\n  color: #c9e2ff;\n  border-radius: 0.2em; }");!function(){"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default={name:"stalker",data:function(){return{left:0,right:0,top:0,bottom:0,text:""}},methods:{applyStalkerText:function(e){var t=this;setTimeout(function(){t.text=e.getAttribute("stalker-text")},10)}},mounted:function(){var e=this;window.addEventListener("mousemove",function(t){var o=t.clientX,n=t.clientY,i=document.documentElement.clientWidth,r=document.documentElement.clientHeight,u=i-240<o,s=r-40<n;e.left=u?null:o,e.right=u?i-o:null,e.top=s?null:n,e.bottom=s?r-n:null,e.applyStalkerText(t.target)}),window.addEventListener("mousedown",function(t){e.applyStalkerText(t.target)}),window.addEventListener("mouseup",function(t){e.applyStalkerText(t.target)})}}}(),module.exports.__esModule&&(module.exports=module.exports.default);var __vue__options__="function"==typeof module.exports?module.exports.options:module.exports;__vue__options__.functional&&console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions."),__vue__options__.render=function(){var e=this,t=e.$createElement,o=e._self._c||t;return o("div",[e.text?o("div",{staticClass:"root",style:{left:"number"==typeof e.left?e.left+"px":void 0,right:"number"==typeof e.right?e.right+"px":void 0,top:"number"==typeof e.top?e.top+"px":void 0,bottom:"number"==typeof e.bottom?e.bottom+"px":void 0}},[e._v("\n    "+e._s(e.text)+"\n  ")]):e._e()])},__vue__options__.staticRenderFns=[],__vue__options__._scopeId="data-v-b396708c",module.hot&&function(){var e=require("vue-hot-reload-api");e.install(require("vue"),!0),e.compatible&&(module.hot.accept(),module.hot.dispose(__vueify_style_dispose__),module.hot.data?e.rerender("data-v-b396708c",__vue__options__):e.createRecord("data-v-b396708c",__vue__options__))}();

},{"vue":66,"vue-hot-reload-api":65,"vueify/lib/insert-css":67}],113:[function(require,module,exports){
var __vueify_style_dispose__=require("vueify/lib/insert-css").insert("/* line 125, stdin */\n.blur-layer[data-v-06efde2a] {\n  position: fixed;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%; }\n\n/* line 133, stdin */\n.root[data-v-06efde2a] {\n  position: absolute;\n  left: calc( 50% - 10em);\n  top: 1em;\n  width: 20em;\n  height: calc( 100% - 2em);\n  overflow: hidden;\n  background: #0e1011;\n  font-size: 0.8em;\n  filter: drop-shadow(0 0 2px #000000); }\n  /* line 146, stdin */\n  .root .search-box[data-v-06efde2a] {\n    position: relative;\n    font-size: 1em;\n    width: calc( 100% - 12px);\n    margin: 2px;\n    padding: 2px 4px;\n    border: none;\n    background: #3d4449;\n    color: #c9e2ff; }\n  /* line 158, stdin */\n  .root .fx-names[data-v-06efde2a] {\n    position: relative;\n    width: 100%;\n    height: calc( 100% - 1em - 12px); }\n    /* line 163, stdin */\n    .root .fx-names .fx-name[data-v-06efde2a] {\n      position: relative;\n      width: calc( 100% - 12px);\n      margin: 2px;\n      padding: 2px 4px;\n      white-space: nowrap;\n      overflow: hidden;\n      text-overflow: ellipsis;\n      background: #202325;\n      cursor: pointer; }\n      /* line 176, stdin */\n      .root .fx-names .fx-name[data-v-06efde2a]:hover {\n        background: #2c3236; }\n      /* line 177, stdin */\n      .root .fx-names .fx-name.selected[data-v-06efde2a] {\n        background: #2c3236; }");!function(){"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=n(require("babel-runtime/helpers/toConsumableArray")),t=n(require("./scrollable.vue"));function n(e){return e&&e.__esModule?e:{default:e}}exports.default={props:["automaton","active"],components:{Scrollable:t.default},data:function(){return{fxDefs:[],searchText:"",selectedIndex:0}},methods:{filterDef:function(e){var t=this.searchText.split(/\s+/),n=this.automaton.getFxDefinitionName(e);return t.every(function(t){return n.toLowerCase().includes(t.toLowerCase())||e.toLowerCase().includes(t.toLowerCase())})},select:function(e){""!==e?(this.$emit("selected",e),this.fxDefs.splice(this.fxDefs.indexOf(e),1),this.fxDefs.unshift(e),this.blur()):this.blur()},blur:function(){this.$emit("blur"),this.searchText="",this.selectedIndex=0},onSearchBoxKeydown:function(e){13===e.which?this.select(this.fxDefsFiltered[this.selectedIndex]):27===e.which?this.blur():38===e.which?this.selectedIndex=(this.selectedIndex-1+this.fxDefsFiltered.length)%this.fxDefsFiltered.length:40===e.which?this.selectedIndex=(this.selectedIndex+1)%this.fxDefsFiltered.length:this.selectedIndex=0}},mounted:function(){this.fxDefs=this.automaton.getFxDefinitionIds()},computed:{fxDefsFiltered:function(){var t,n=this;(t=this.fxDefs).push.apply(t,(0,e.default)(this.automaton.getFxDefinitionIds().filter(function(e){return-1===n.fxDefs.indexOf(e)})));var i=this.fxDefs.filter(function(e){return n.filterDef(e)});return 0===i.length?[""]:i}},watch:{active:function(e){var t=this;e&&setTimeout(function(){t.$refs.searchBox.focus()},10)}}}}(),module.exports.__esModule&&(module.exports=module.exports.default);var __vue__options__="function"==typeof module.exports?module.exports.options:module.exports;__vue__options__.functional&&console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions."),__vue__options__.render=function(){var e=this,t=e.$createElement,n=e._self._c||t;return n("div",[e.active?n("div",{staticClass:"blur-layer",on:{mousedown:e.blur}}):e._e(),e._v(" "),e.active?n("div",{staticClass:"root"},[n("input",{directives:[{name:"model",rawName:"v-model",value:e.searchText,expression:"searchText"}],ref:"searchBox",staticClass:"search-box",attrs:{type:"text",placeholder:"Add a fx..."},domProps:{value:e.searchText},on:{keydown:e.onSearchBoxKeydown,input:function(t){t.target.composing||(e.searchText=t.target.value)}}}),e._v(" "),n("Scrollable",{staticClass:"fx-names",attrs:{bar:"right"}},e._l(e.fxDefsFiltered,function(t,i){return n("div",{key:t,staticClass:"fx-name",class:{selected:i===e.selectedIndex},attrs:{"stalker-text":e.automaton.getFxDefinitionDescription(t)||"(no description provided)"},on:{mousedown:function(n){e.select(t)}}},[e._v("\n        "+e._s(t?e.automaton.getFxDefinitionName(t):"(No result found)")+"\n      ")])}))],1):e._e()])},__vue__options__.staticRenderFns=[],__vue__options__._scopeId="data-v-06efde2a",module.hot&&function(){var e=require("vue-hot-reload-api");e.install(require("vue"),!0),e.compatible&&(module.hot.accept(),module.hot.dispose(__vueify_style_dispose__),module.hot.data?e.rerender("data-v-06efde2a",__vue__options__):e.createRecord("data-v-06efde2a",__vue__options__))}();

},{"./scrollable.vue":111,"babel-runtime/helpers/toConsumableArray":4,"vue":66,"vue-hot-reload-api":65,"vueify/lib/insert-css":67}],114:[function(require,module,exports){
var __vueify_style_dispose__=require("vueify/lib/insert-css").insert("/* line 1036, stdin */\n.root[data-v-5f617a83] {\n  position: absolute;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  color: #c9e2ff; }\n  /* line 1045, stdin */\n  .root .hbar[data-v-5f617a83] {\n    position: absolute;\n    left: 0;\n    bottom: 0;\n    width: 100%;\n    height: 4px;\n    background: #000000; }\n    /* line 1054, stdin */\n    .root .hbar .vision[data-v-5f617a83] {\n      position: absolute;\n      bottom: 0;\n      height: 100%;\n      border-radius: 2px;\n      background: #22aaff; }\n  /* line 1065, stdin */\n  .root .svg[data-v-5f617a83] {\n    background: #0e1011;\n    font-size: 10px;\n    pointer-events: none; }\n    /* line 1072, stdin */\n    .root .svg .grid[data-v-5f617a83] {\n      stroke: #c9e2ff;\n      stroke-width: 1; }\n    /* line 1077, stdin */\n    .root .svg .grid-text[data-v-5f617a83] {\n      fill: #c9e2ff; }\n    /* line 1081, stdin */\n    .root .svg .graph[data-v-5f617a83] {\n      fill: none;\n      stroke: #c9e2ff;\n      stroke-width: 2; }\n    /* line 1087, stdin */\n    .root .svg .currentLine[data-v-5f617a83] {\n      stroke: #22aaff;\n      stroke-width: 2; }\n    /* line 1092, stdin */\n    .root .svg .currentText[data-v-5f617a83] {\n      fill: #22aaff; }\n    /* line 1096, stdin */\n    .root .svg .currentPoint[data-v-5f617a83] {\n      fill: #22aaff; }\n    /* line 1102, stdin */\n    .root .svg .node .handle .line[data-v-5f617a83] {\n      stroke: #22aaff;\n      stroke-width: 1; }\n    /* line 1107, stdin */\n    .root .svg .node .handle .circle[data-v-5f617a83] {\n      fill: #22aaff;\n      pointer-events: auto;\n      cursor: pointer; }\n    /* line 1115, stdin */\n    .root .svg .node .body[data-v-5f617a83] {\n      fill: #0e1011;\n      stroke: #22aaff;\n      stroke-width: 2;\n      pointer-events: auto;\n      cursor: pointer; }\n      /* line 1123, stdin */\n      .root .svg .node .body.selected[data-v-5f617a83] {\n        fill: #22aaff; }\n    /* line 1130, stdin */\n    .root .svg .fx .line[data-v-5f617a83] {\n      stroke: #0fd895;\n      stroke-width: 1;\n      stroke-dasharray: 4; }\n    /* line 1136, stdin */\n    .root .svg .fx .fill[data-v-5f617a83] {\n      fill: #0fd895;\n      opacity: 0.1; }\n    /* line 1141, stdin */\n    .root .svg .fx .body[data-v-5f617a83] {\n      fill: #0e1011;\n      stroke: #0fd895;\n      stroke-width: 2;\n      pointer-events: auto;\n      cursor: pointer; }\n      /* line 1146, stdin */\n      .root .svg .fx .body.bypass[data-v-5f617a83] {\n        fill: #0e1011;\n        stroke: #687788; }\n      /* line 1151, stdin */\n      .root .svg .fx .body.selected[data-v-5f617a83] {\n        fill: #0fd895;\n        stroke: #0e1011; }\n        /* line 1155, stdin */\n        .root .svg .fx .body.selected.bypass[data-v-5f617a83] {\n          fill: #687788;\n          stroke: #0e1011; }\n    /* line 1165, stdin */\n    .root .svg .fx .text[data-v-5f617a83] {\n      fill: #0fd895; }\n      /* line 1167, stdin */\n      .root .svg .fx .text.bypass[data-v-5f617a83] {\n        fill: #687788; }\n      /* line 1168, stdin */\n      .root .svg .fx .text.selected[data-v-5f617a83] {\n        fill: #0e1011; }\n    /* line 1171, stdin */\n    .root .svg .fx .side[data-v-5f617a83] {\n      fill: rgba(0, 0, 0, 0);\n      pointer-events: auto;\n      cursor: ew-resize; }");!function(){"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var t=n(require("babel-runtime/core-js/math/log10")),e=n(require("../param-gui")),i=n(require("./timeline-fxmenu.vue"));function n(t){return t&&t.__esModule?t:{default:t}}exports.default={components:{FxMenu:i.default},props:["automaton","selectedParamName","selectedNodeIds","selectedFxIds"],data:function(){return{width:100,height:100,t0:0,t1:this.automaton.length,v0:-.25,v1:1.25,grid:{x:[],y:[]},graphPoints:"",fxmenuActive:!1,fxmenuTime:0}},methods:{updateGrid:function(){this.grid={x:[],y:[]};for(var e=this.t1-this.t0,i=(0,t.default)(e),n=Math.pow(10,Math.floor(i)-1),o=i-Math.floor(i),a=Math.floor(this.t0/n),s=a*n,r=a-10*Math.floor(a/10),u=a-100*Math.floor(a/100),l=s;l<this.t1;l+=n){var d=0===u?.4:0===r?.4-.3*o:.1-.3*o;0<d&&this.grid.x.push({val:l+1e-9,pos:this.t2x(l),op:d}),r=(r+1)%10,u=(u+1)%100}for(var h=this.v1-this.v0,c=(0,t.default)(h),f=Math.pow(10,Math.floor(c)-1),v=c-Math.floor(c),m=Math.floor(this.v0/f),x=m*f,p=m-10*Math.floor(m/10),g=m-100*Math.floor(m/100),y=x;y<this.v1;y+=f){var _=0===g?.4:0===p?.4-.3*v:.1-.3*v;0<_&&this.grid.y.push({val:y+1e-9,pos:this.v2y(y),op:_}),p=(p+1)%10,g=(g+1)%100}},updateGraph:function(){var t=this.selectedParam;if(t){for(var e="",i=0;i<=this.width;i++){var n=this.x2t(i),o=t.getValue(n);e+=i+" "+this.v2y(o)+" "}this.graphPoints=e}},x2t:function(t){return t/this.width*(this.t1-this.t0)+this.t0},t2x:function(t){return(t-this.t0)/(this.t1-this.t0)*this.width},y2v:function(t){return(1-t/this.height)*(this.v1-this.v0)+this.v0},v2y:function(t){return(1-(t-this.v0)/(this.v1-this.v0))*this.height},moveView:function(t,e){var i=this.x2t(0)-this.x2t(t),n=this.y2v(0)-this.y2v(e);i=Math.min(Math.max(i,-this.t0),this.automaton.length-this.t1),this.t0+=i,this.t1+=i,this.v0+=n,this.v1+=n,this.updateGrid(),this.updateGraph()},zoomView:function(t,e,i,n){var o=(t-this.t0)/(this.t1-this.t0),a=(e-this.v0)/(this.v1-this.v0),s=this.t1-this.t0;s*=Math.pow((this.width+1)/this.width,2*i),s=Math.min(Math.max(s,.01),1e3);var r=this.v1-this.v0;r*=Math.pow((this.width+1)/this.width,2*n),r=Math.min(Math.max(r,.01),1e3),this.t0=t-o*s,this.t1=t+(1-o)*s,this.v0=e-a*r,this.v1=e+(1-a)*r,this.t0<0&&(this.t1=Math.max(this.t1-this.t0,this.t1)),this.automaton.length<this.t1&&(this.t0+=this.automaton.length-this.t1),this.t0<0&&(this.t0=0),this.automaton.length<this.t1&&(this.t1=this.automaton.length),this.updateGrid(),this.updateGraph()},createNode:function(t,e){var i=this.selectedParam;if(i){var n=i.createNode(t,e),o=i.dumpNode(n);this.$emit("nodeSelected",[n]),this.$emit("fxSelected",[]),this.automaton.pushHistory("Create Node",function(){return i.createNodeFromData(o)},function(){return i.removeNode(n)})}},removeNode:function(t){var e=this.selectedParam;if(e){var i=e.dumpNode(t);i.in&&i.out&&(this.automaton.pushHistory("Remove Node",function(){return e.removeNode(t)},function(){return e.createNodeFromData(i)},!0),this.$emit("nodeSelected",[]))}},removeHandle:function(t,e){var i=this.selectedParam;if(i){var n=i.dumpNode(t),o=e?n.out.time:n.in.time,a=e?n.out.value:n.in.value;i.moveHandle(t,e,0,0),this.automaton.pushHistory("Remove Handle",function(){return i.moveHandle(t,e,0,0)},function(){return i.moveHandle(t,e,o,a)},!0)}},resetHandles:function(t){var e=this.selectedParam;if(e){var i=e.dumpNode(t);this.automaton.pushHistory("Reset Handle",function(){e.resetHandle(t,!1),e.resetHandle(t,!0)},function(){e.moveHandle(t,!1,i.in.time,i.in.value),e.moveHandle(t,!0,i.out.time,i.out.value)},!0)}},grabHelper:function(t,e){var i=this,n=t.clientX,o=t.clientY,a=this.x2t(n),s=this.y2v(o),r=!1,u=function(t){var n=i.x2t(t.clientX)-a,o=i.y2v(t.clientY)-s;r=!0,e(n,o,t)};window.addEventListener("mousemove",u),window.addEventListener("mouseup",function t(n){if(r){var o=i.x2t(n.clientX)-a,l=i.y2v(n.clientY)-s;e(o,l,n,!0)}window.removeEventListener("mousemove",u),window.removeEventListener("mouseup",t)})},snapTime:function(t){if(!this.automaton.guiSettings.snapActive)return t;var e=this.automaton.guiSettings.snapTime,i=5/this.width*(this.t1-this.t0),n=Math.round(t/e)*e;return Math.abs(t-n)<i?n:t},snapValue:function(t){if(!this.automaton.guiSettings.snapActive)return t;var e=this.automaton.guiSettings.snapValue,i=5/this.height*(this.v1-this.v0),n=Math.round(t/e)*e;return Math.abs(t-n)<i?n:t},grabNode:function(t,e){var i=this,n=this.selectedParam;if(n){this.$emit("nodeSelected",[t]),this.$emit("fxSelected",[]);var o=n.dumpNode(t),a=o.time,s=o.value;this.grabHelper(e,function(e,o,r,u){var l=a+e,d=s+o;r.altKey||(l=i.snapTime(l),d=i.snapValue(d)),r.shiftKey?d=s:(r.ctrlKey||r.metaKey)&&(l=a),n.moveNode(t,l,d),u&&i.automaton.pushHistory("Move Node",function(){return n.moveNode(t,l,d)},function(){return n.moveNode(t,a,s)})})}},grabHandle:function(t,e,i){var n=this,o=this.selectedParam;if(o){var a=o.dumpNode(t),s=e?a.out:a.in,r=s.time,u=s.value,l=Math.sqrt(r*r+u*u),d=r/l,h=u/l,c=e?a.in:a.out,f=c?c.time:0,v=c?c.value:0;this.grabHelper(i,function(i,a,s,l){var c=r+i,m=u+a,x=f,p=v;if(s.shiftKey){var g=c*d+m*h;c=g*d,m=g*h}else(s.ctrlKey||s.metaKey)&&(x=-c,p=-m);o.moveHandle(t,e,c,m),o.moveHandle(t,!e,x,p),l&&n.automaton.pushHistory("Move Handle",function(){o.moveHandle(t,e,c,m),o.moveHandle(t,!e,x,p)},function(){o.moveHandle(t,e,r,u),o.moveHandle(t,!e,f,v)})})}},openFxMenu:function(t){this.fxmenuActive=!0,this.fxmenuTime=t},createFx:function(t,e){var i=this.selectedParam;if(i){var n=this.fxmenuTime,o=Math.min(1,this.automaton.length-this.fxmenuTime),a=i.createFx(n,o,e),s=i.dumpFx(a);a&&(this.$emit("nodeSelected",[]),this.$emit("fxSelected",[a]),this.automaton.pushHistory("Create Fx",function(){return i.createFxFromData(s)},function(){return i.removeFx(a)}))}},removeFx:function(t){var e=this.selectedParam;if(e){var i=e.dumpFx(t);this.automaton.pushHistory("Remove Fx",function(){return e.removeFx(t)},function(){return e.createFxFromData(i)},!0),this.$emit("fxSelected",[])}},grabFxBody:function(t,i){var n=this,o=this.selectedParam;if(o){this.$emit("nodeSelected",[]),this.$emit("fxSelected",[t]);var a=o.dumpFx(t),s=a.time,r=a.row,u=i.clientY;this.grabHelper(i,function(i,a,l,d){var h=l.clientY-u,c=Math.min(Math.max(r+Math.round(h/16),0),e.default.FX_ROW_MAX),f=s+i;l.altKey||(f=n.snapTime(f)),o.moveFx(t,f),o.changeFxRow(t,c),d&&n.automaton.pushHistory("Move Fx",function(){return o.forceMoveFx(t,f,c)},function(){return o.forceMoveFx(t,s,r)})})}},grabFxLeft:function(t,e){var i=this,n=this.selectedParam;if(n){this.$emit("nodeSelected",[]),this.$emit("fxSelected",[t]);var o=n.dumpFx(t),a=o.length,s=o.time+a;this.grabHelper(e,function(e,o,r,u){var l=a-e;r.altKey||(l=i.snapTime(l-s)+s),n.resizeFxByLeft(t,l),u&&i.automaton.pushHistory("Resize Fx",function(){return n.resizeFxByLeft(t,l)},function(){return n.resizeFxByLeft(t,a)})})}},grabFxRight:function(t,e){var i=this,n=this.selectedParam;if(n){this.$emit("nodeSelected",[]),this.$emit("fxSelected",[t]);var o=n.dumpFx(t),a=o.length,s=o.time;this.grabHelper(e,function(e,o,r,u){var l=a+e;r.altKey||(l=i.snapTime(l+s)-s),n.resizeFx(t,l),u&&i.automaton.pushHistory("Resize Fx",function(){return n.resizeFx(t,l)},function(){return n.resizeFx(t,a)})})}},dragBg:function(t){var e=this,i=this.x2t(t.offsetX),n=this.y2v(t.offsetY),o=t.which,a=t.shiftKey,s=t.altKey,r=t.clientX,u=t.clientY,l=r,d=u,h=this.automaton.isPlaying;s&&(this.automaton.seek(i),h&&this.automaton.pause());var c=function(t){var u=t.clientX,h=t.clientY,c=t.clientX-l,f=t.clientY-d;1===o?s&&e.automaton.seek(i+e.x2t(u)-e.x2t(r)):2===o&&(a?e.zoomView(i,n,-c,f):e.moveView(c,f)),l=u,d=h};window.addEventListener("mousemove",c),window.addEventListener("mouseup",function t(i){s&&h&&e.automaton.play(),window.removeEventListener("mousemove",c),window.removeEventListener("mouseup",t)})},contextBg:function(t){var e=this;if(this.selectedParam){var i=this.x2t(t.offsetX),n=this.y2v(t.offsetY);this.$emit("context",{clientX:t.clientX,clientY:t.clientY,commands:[{text:"Add Node",func:function(){e.createNode(i,n)}},{text:"Add Fx",func:function(){e.openFxMenu(i)}}]})}},onWheel:function(t){var e=this.x2t(t.offsetX),i=this.y2v(t.offsetY);t.shiftKey?this.zoomView(e,i,-t.deltaY,0):t.ctrlKey||t.metaKey?this.zoomView(e,i,0,-t.deltaY):this.moveView(t.deltaX,-t.deltaY),this.updateGrid(),this.updateGraph()},onResize:function(){var t=this,e=this.$refs.root;this.width=e.clientWidth,this.height=e.clientHeight-4,this.$nextTick(function(){t.updateGrid(),t.updateGraph()})}},computed:{selectedParam:function(){return this.automaton.getParam(this.selectedParamName)}},watch:{selectedParamName:function(){this.updateGraph()}},mounted:function(){var t=this;this.$root.$on("loaded",function(){t.t0=0,t.t1=t.automaton.length}),this.$root.$on("changedLength",function(){t.t0=0,t.t1=t.automaton.length,t.updateGraph()}),this.$root.$on("poke",function(){t.updateGraph()}),this.$nextTick(function(){t.onResize()}),window.addEventListener("resize",this.onResize)},beforeDestroy:function(){window.removeEventListener("resize",this.onResize)}}}(),module.exports.__esModule&&(module.exports=module.exports.default);var __vue__options__="function"==typeof module.exports?module.exports.options:module.exports;__vue__options__.functional&&console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions."),__vue__options__.render=function(){var t=this,e=t.$createElement,i=t._self._c||e;return i("div",[i("div",{ref:"root",staticClass:"root",on:{wheel:function(e){return e.preventDefault(),t.onWheel(e)},dragstart:function(t){t.preventDefault()},mousedown:function(e){return e.preventDefault(),e.stopPropagation(),t.dragBg(e)},dblclick:function(e){return"button"in e||!t._k(e.keyCode,"left",37,e.key,["Left","ArrowLeft"])?"button"in e&&0!==e.button?null:(e.stopPropagation(),void t.createNode(t.x2t(e.offsetX),t.y2v(e.offsetY))):null},contextmenu:function(e){return e.stopPropagation(),e.preventDefault(),t.contextBg(e)}}},[i("div",{staticClass:"hbar"},[i("div",{staticClass:"vision",style:{left:t.t0/t.automaton.length*t.width+"px",width:(t.t1-t.t0)/t.automaton.length*t.width+"px"}})]),t._v(" "),i("svg",{staticClass:"svg",attrs:{width:t.width,height:t.height,viewBox:"0 0 "+t.width+" "+t.height}},[t._l(t.grid.x,function(e,n){return i("line",{key:"grid-x"+n,staticClass:"grid",attrs:{x1:e.pos,y1:0,x2:e.pos,y2:t.height,opacity:e.op}})}),t._v(" "),t._l(t.grid.y,function(e,n){return i("line",{key:"grid-y"+n,staticClass:"grid",attrs:{x1:0,y1:e.pos,x2:t.width,y2:e.pos,opacity:e.op}})}),t._v(" "),t._l(t.grid.x,function(e,n){return i("text",{key:"grid-text-x"+n,staticClass:"grid-text",attrs:{x:e.pos+2,y:t.height-2,opacity:e.op}},[t._v(t._s(e.val.toFixed(3)))])}),t._v(" "),t._l(t.grid.y,function(e,n){return i("text",{key:"grid-text-y"+n,staticClass:"grid-text",attrs:{x:"2",y:e.pos-2,opacity:e.op}},[t._v(t._s(e.val.toFixed(3)))])}),t._v(" "),t.selectedParam?i("g",[t._l(t.selectedParam.dumpFxs(),function(e){return i("g",{key:e.$id,staticClass:"fx"},[i("line",{staticClass:"line",attrs:{x1:t.t2x(e.time),y1:"4",x2:t.t2x(e.time),y2:t.height}}),t._v(" "),i("line",{staticClass:"line",attrs:{x1:t.t2x(e.time+e.length),y1:"4",x2:t.t2x(e.time+e.length),y2:t.height}}),t._v(" "),i("rect",{staticClass:"fill",attrs:{x:t.t2x(e.time),y:"0",width:t.t2x(e.time+e.length)-t.t2x(e.time),height:t.height}}),t._v(" "),i("g",{attrs:{transform:"translate(0,"+(1+16*e.row)+")"}},[i("rect",{staticClass:"body",class:{selected:t.selectedFxIds.some(function(t){return t===e.$id}),bypass:e.bypass},attrs:{x:t.t2x(e.time),width:t.t2x(e.time+e.length)-t.t2x(e.time),height:"16",rx:"5",ry:"5"},on:{mousedown:function(i){return"button"in i||!t._k(i.keyCode,"left",37,i.key,["Left","ArrowLeft"])?"button"in i&&0!==i.button?null:(i.stopPropagation(),void t.grabFxBody(e.$id,i)):null},dblclick:function(i){i.stopPropagation(),t.removeFx(e.$id)}}}),t._v(" "),i("rect",{staticClass:"side",attrs:{x:t.t2x(e.time)-1,width:"6",height:"16"},on:{mousedown:function(i){return"button"in i||!t._k(i.keyCode,"left",37,i.key,["Left","ArrowLeft"])?"button"in i&&0!==i.button?null:(i.stopPropagation(),void t.grabFxLeft(e.$id,i)):null}}}),t._v(" "),i("rect",{staticClass:"side",attrs:{x:t.t2x(e.time+e.length)-5,width:"6",height:"16"},on:{mousedown:function(i){return"button"in i||!t._k(i.keyCode,"left",37,i.key,["Left","ArrowLeft"])?"button"in i&&0!==i.button?null:(i.stopPropagation(),void t.grabFxRight(e.$id,i)):null}}}),t._v(" "),i("clipPath",{attrs:{id:"fxclip"+e.$id}},[i("rect",{attrs:{x:t.t2x(e.time),width:t.t2x(e.time+e.length)-t.t2x(e.time),height:"16"}})]),t._v(" "),i("g",{attrs:{"clip-path":"url(#fxclip"+e.$id+")"}},[i("text",{staticClass:"text",class:{selected:t.selectedFxIds.some(function(t){return t===e.$id}),bypass:e.bypass},attrs:{x:t.t2x(e.time)+4,y:"12"}},[t._v(t._s(t.automaton.getFxDefinitionName(e.def)))])])])])}),t._v(" "),t.selectedParam?i("polyline",{staticClass:"graph",attrs:{points:t.graphPoints}}):t._e(),t._v(" "),i("line",{staticClass:"currentLine",attrs:{x1:t.t2x(t.automaton.time),y1:"0",x2:t.t2x(t.automaton.time),y2:t.height}}),t._v(" "),i("text",{staticClass:"currentText",attrs:{x:t.t2x(t.automaton.time)+2,y:t.height-2}},[t._v(t._s(t.automaton.time.toFixed(3)))]),t._v(" "),t.selectedParam?i("g",[i("line",{staticClass:"currentLine",attrs:{x1:"0",y1:t.v2y(t.selectedParam.getValue()),x2:t.width,y2:t.v2y(t.selectedParam.getValue())}}),t._v(" "),i("text",{staticClass:"currentText",attrs:{x:"2",y:t.v2y(t.selectedParam.getValue())-2}},[t._v(t._s(t.selectedParam.getValue().toFixed(3)))]),t._v(" "),i("circle",{staticClass:"currentPoint",attrs:{r:"5",cx:t.t2x(t.automaton.time),cy:t.v2y(t.selectedParam.getValue())}})]):t._e()],2):t._e(),t._v(" "),t.selectedParam?i("g",t._l(t.selectedParam.dumpNodes(),function(e){return i("g",{key:e.$id,staticClass:"node"},[i("g",{staticClass:"handle"},[e.in?i("line",{staticClass:"line",attrs:{x1:t.t2x(e.time),y1:t.v2y(e.value),x2:t.t2x(e.time+e.in.time),y2:t.v2y(e.value+e.in.value)}}):t._e(),t._v(" "),e.in?i("circle",{staticClass:"circle",attrs:{r:"4",transform:"translate("+t.t2x(e.time+e.in.time)+","+t.v2y(e.value+e.in.value)+")"},on:{mousedown:function(i){return"button"in i||!t._k(i.keyCode,"left",37,i.key,["Left","ArrowLeft"])?"button"in i&&0!==i.button?null:(i.stopPropagation(),void t.grabHandle(e.$id,!1,i)):null},dblclick:function(i){i.stopPropagation(),t.removeHandle(e.$id,!1)}}}):t._e(),t._v(" "),e.out?i("line",{staticClass:"line",attrs:{x1:t.t2x(e.time),y1:t.v2y(e.value),x2:t.t2x(e.time+e.out.time),y2:t.v2y(e.value+e.out.value)}}):t._e(),t._v(" "),e.out?i("circle",{staticClass:"circle",attrs:{r:"4",transform:"translate("+t.t2x(e.time+e.out.time)+","+t.v2y(e.value+e.out.value)+")"},on:{mousedown:function(i){return"button"in i||!t._k(i.keyCode,"left",37,i.key,["Left","ArrowLeft"])?"button"in i&&0!==i.button?null:(i.stopPropagation(),void t.grabHandle(e.$id,!0,i)):null},dblclick:function(i){i.stopPropagation(),t.removeHandle(e.$id,!0)}}}):t._e()]),t._v(" "),i("g",{staticClass:"body",class:{selected:t.selectedNodeIds.some(function(t){return t===e.$id})},on:{dblclick:function(i){i.stopPropagation(),t.removeNode(e.$id)},mousedown:[function(i){return"button"in i||!t._k(i.keyCode,"left",37,i.key,["Left","ArrowLeft"])?"button"in i&&0!==i.button?null:i.shiftKey?(i.stopPropagation(),void t.resetHandles(e.$id)):null:null},function(i){return"button"in i||!t._k(i.keyCode,"left",37,i.key,["Left","ArrowLeft"])?"button"in i&&0!==i.button?null:(i.stopPropagation(),void t.grabNode(e.$id,i)):null}]}},[t.v0<=e.value&&e.value<=t.v1?i("circle",{staticClass:"circle",attrs:{transform:"translate("+t.t2x(e.time)+","+t.v2y(e.value)+")",r:"5"}}):t._e(),t._v(" "),e.value<t.v0?i("path",{staticClass:"triangle",attrs:{transform:"translate("+t.t2x(e.time)+","+t.height+")",d:"M 0 -4 L 5 -12 L -5 -12 z"}}):t._e(),t._v(" "),t.v1<e.value?i("path",{staticClass:"triangle",attrs:{transform:"translate("+t.t2x(e.time)+",0)",d:"M 0 4 L -5 12 L 5 12 z"}}):t._e()])])})):t._e()],2),t._v(" "),i("FxMenu",{attrs:{automaton:t.automaton,active:t.fxmenuActive},on:{selected:function(e){t.createFx(t.fxmenuTime,e)},blur:function(e){t.fxmenuActive=!1}}})],1)])},__vue__options__.staticRenderFns=[],__vue__options__._scopeId="data-v-5f617a83",module.hot&&function(){var t=require("vue-hot-reload-api");t.install(require("vue"),!0),t.compatible&&(module.hot.accept(),module.hot.dispose(__vueify_style_dispose__),module.hot.data?t.rerender("data-v-5f617a83",__vue__options__):t.createRecord("data-v-5f617a83",__vue__options__))}();

},{"../param-gui":102,"./timeline-fxmenu.vue":113,"babel-runtime/core-js/math/log10":2,"vue":66,"vue-hot-reload-api":65,"vueify/lib/insert-css":67}]},{},[100])(100)
});

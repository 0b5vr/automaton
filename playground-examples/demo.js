...
function drawZigZag( channel, color ) {
  const pos = auto( channel );
...
playground.update = () => {
  ...
  drawZigZag( 'zigzag/pos0', '#301726' );
  drawZigZag( 'zigzag/pos1', '#30201f' );
  drawZigZag( 'zigzag/pos2', '#2f2f20' );
  drawZigZag( 'zigzag/pos3', '#2b2f35' );
